...
/* loaded from: classes-dex2jar.jar:retrofit2/ServiceMethod.class */
final class ServiceMethod<R, T> {
    ...
    /* loaded from: classes-dex2jar.jar:retrofit2/ServiceMethod$Builder.class */
    static final class Builder<T, R> {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            Headers headersM17of = Headers.m17of("Content-Disposition", "form-data; name=\"" + strValue5 + "\"", "Content-Transfer-Encoding", part.encoding());
            if (!Iterable.class.isAssignableFrom(rawType9)) {
                if (!rawType9.isArray()) {
                    if (MultipartBody.Part.class.isAssignableFrom(rawType9)) {
                    ...
                    return new ParameterHandler.Part(headersM17of, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
                }
                ...
                return new ParameterHandler.Part(headersM17of, this.retrofit.requestBodyConverter(clsBoxIfPrimitive, annotationArr, this.methodAnnotations)).array();
            }
            if (type instanceof ParameterizedType) {
                ...
                return new ParameterHandler.Part(headersM17of, this.retrofit.requestBodyConverter(parameterUpperBound6, annotationArr, this.methodAnnotations)).iterable();
            }
            throw parameterError(i, rawType9.getSimpleName() + " must include generic type (e.g., " + rawType9.getSimpleName() + "<String>)", new Object[0]);
        }
    ...
    okhttp3.Call toCall(@Nullable Object... objArr) throws IOException {
