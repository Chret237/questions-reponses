...
class VersionedParcelStream extends VersionedParcel {
    ...
    /* loaded from: classes-dex2jar.jar:androidx/versionedparcelable/VersionedParcelStream$InputBuffer.class */
    ...
    public boolean readField(int i) throws IOException {
        ...
        while (true) {
            try {
                ...
                InputBuffer inputBuffer2 = new InputBuffer((i2 >> 16) & SupportMenu.USER_MASK, i4, this.mMasterInput);
