...
public final class MultipartBody extends RequestBody {
    ...
    public static final class Part {
        ...
        public static Part createFormData(String str, @Nullable String str2, RequestBody requestBody) {
            ...
            return create(Headers.m17of("Content-Disposition", sb.toString()), requestBody);
        }
    ...
    private long writeOrCountBytes(@Nullable BufferedSink bufferedSink, boolean z) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (mediaTypeContentType != null) {
                buffer.writeUtf8("Content-Type: ").writeUtf8(mediaTypeContentType.toString()).write(CRLF);
            }
            long jContentLength = requestBody.contentLength();
            if (jContentLength != -1) {
                buffer.writeUtf8("Content-Length: ").writeDecimalLong(jContentLength).write(CRLF);
            } else if (z) {
                bufferedSink2.clear();
                return -1L;
            }
