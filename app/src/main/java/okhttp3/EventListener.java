...
/* loaded from: classes-dex2jar.jar:okhttp3/EventListener.class */
public abstract class EventListener {
    public static final EventListener NONE = new EventListener() { // from class: okhttp3.EventListener.1
    };

    /* loaded from: classes-dex2jar.jar:okhttp3/EventListener$Factory.class */
    public interface Factory {
        EventListener create(Call call);
    }

    static Factory factory(EventListener eventListener) {
        return new Factory(eventListener) { // from class: okhttp3.EventListener.2
