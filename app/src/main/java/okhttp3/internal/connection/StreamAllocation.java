    ...
    */
        ...
        synchronized (this.connectionPool) {
            ...
            if (z3) {
                ...
                while (true) {
                    ...
                    if (this.connection != null) {
                        realConnection6 = this.connection;
                        this.route = route2;
                        z4 = true;
                        break;
                    }
            ...
            if (!z4) {
                ...
                RealConnection realConnection7 = new RealConnection(this.connectionPool, next);
                acquire(realConnection7, false);
    ...
    public void streamFailed(IOException iOException) throws IOException {
        ...
        synchronized (this.connectionPool) {
            ...
            realConnection = null;
            if (this.connection == null) {
                realConnection = !this.reportedAcquired ? null : realConnection2;
            }
        }
        Util.closeQuietly(socketDeallocate);
        if (realConnection != null) {
