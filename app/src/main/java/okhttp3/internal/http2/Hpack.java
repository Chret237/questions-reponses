...
/* loaded from: classes-dex2jar.jar:okhttp3/internal/http2/Hpack.class */
final class Hpack {
    ...
    /* loaded from: classes-dex2jar.jar:okhttp3/internal/http2/Hpack$Reader.class */
    static final class Reader {
        ...
        ByteString readByteString() throws IOException {
            ...
            return z ? ByteString.m19of(Huffman.get().decode(this.source.readByteArray(i2))) : this.source.readByteString(i2);
        }
    ...
    /* loaded from: classes-dex2jar.jar:okhttp3/internal/http2/Hpack$Writer.class */
    static final class Writer {
        ...
        */
        void writeHeaders(java.util.List<okhttp3.internal.http2.Header> r6) throws java.io.IOException {
            /*
