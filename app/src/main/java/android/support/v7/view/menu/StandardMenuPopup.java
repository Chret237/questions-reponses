...
/* loaded from: classes-dex2jar.jar:android/support/v7/view/menu/StandardMenuPopup.class */
final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, MenuPresenter, View.OnKeyListener {
    private static final int ITEM_LAYOUT = C0287R.layout.abc_popup_menu_item_layout;
    ...
    final ViewTreeObserver.OnGlobalLayoutListener mGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener(this) { // from class: android.support.v7.view.menu.StandardMenuPopup.1
    ...
    private final View.OnAttachStateChangeListener mAttachStateChangeListener = new View.OnAttachStateChangeListener(this) { // from class: android.support.v7.view.menu.StandardMenuPopup.2
        final StandardMenuPopup this$0;
    ...
    public StandardMenuPopup(Context context, MenuBuilder menuBuilder, View view, int i, int i2, boolean z) {
        ...
        this.mPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0287R.dimen.abc_config_prefDialogWidth));
    ...
    private boolean tryShow() {
        ...
        if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C0287R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
    ...
    public boolean onSubMenuSelected(SubMenuBuilder subMenuBuilder) {
        ...
        if ((Gravity.getAbsoluteGravity(this.mDropDownGravity, ViewCompat.getLayoutDirection(this.mAnchorView)) & 7) == 5) {
            width = horizontalOffset + this.mAnchorView.getWidth();
        }
        if (!menuPopupHelper.tryShow(width, verticalOffset)) {
            return false;
        }
        MenuPresenter.Callback callback = this.mPresenterCallback;
        if (callback == null) {
