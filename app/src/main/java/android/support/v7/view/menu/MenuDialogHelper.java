...
/* loaded from: classes-dex2jar.jar:android/support/v7/view/menu/MenuDialogHelper.class */
class MenuDialogHelper implements DialogInterface.OnKeyListener, DialogInterface.OnClickListener, DialogInterface.OnDismissListener, MenuPresenter.Callback {
    ...
    public void show(IBinder iBinder) {
        ...
        ListMenuPresenter listMenuPresenter = new ListMenuPresenter(builder.getContext(), C0287R.layout.abc_list_menu_item_layout);
