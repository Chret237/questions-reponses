...
/* loaded from: classes-dex2jar.jar:android/support/v7/view/menu/MenuPresenter.class */
public interface MenuPresenter {

    /* loaded from: classes-dex2jar.jar:android/support/v7/view/menu/MenuPresenter$Callback.class */
