...
/* loaded from: classes-dex2jar.jar:android/support/v7/view/menu/MenuItemWrapperICS.class */
public class MenuItemWrapperICS extends BaseMenuWrapper<SupportMenuItem> implements MenuItem {
    static final String LOG_TAG = "MenuItemWrapper";
    private Method mSetExclusiveCheckableMethod;

    /* loaded from: classes-dex2jar.jar:android/support/v7/view/menu/MenuItemWrapperICS$ActionProviderWrapper.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/view/menu/MenuItemWrapperICS$OnActionExpandListenerWrapper.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/view/menu/MenuItemWrapperICS$OnMenuItemClickListenerWrapper.class */
    ...
    public View getActionView() {
        ...
        View wrappedView = actionView;
        if (actionView instanceof CollapsibleActionViewWrapper) {
            wrappedView = ((CollapsibleActionViewWrapper) actionView).getWrappedView();
        }
        return wrappedView;
    }
    ...
    public MenuItem setOnActionExpandListener(MenuItem.OnActionExpandListener onActionExpandListener) {
        ((SupportMenuItem) this.mWrappedObject).setOnActionExpandListener(onActionExpandListener != null ? new OnActionExpandListenerWrapper(this, onActionExpandListener) : null);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setOnMenuItemClickListener(MenuItem.OnMenuItemClickListener onMenuItemClickListener) {
        ((SupportMenuItem) this.mWrappedObject).setOnMenuItemClickListener(onMenuItemClickListener != null ? new OnMenuItemClickListenerWrapper(this, onMenuItemClickListener) : null);
        return this;
    }
