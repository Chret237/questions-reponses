...
/* loaded from: classes-dex2jar.jar:android/support/v7/view/menu/MenuBuilder.class */
public class MenuBuilder implements SupportMenu {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/view/menu/MenuBuilder$Callback.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/view/menu/MenuBuilder$ItemInvoker.class */
    ...
    private boolean dispatchSubMenuSelected(SubMenuBuilder subMenuBuilder, MenuPresenter menuPresenter) {
        ...
        if (menuPresenter != null) {
            zOnSubMenuSelected = menuPresenter.onSubMenuSelected(subMenuBuilder);
        }
        Iterator<WeakReference<MenuPresenter>> it = this.mPresenters.iterator();
        while (it.hasNext()) {
            WeakReference<MenuPresenter> next = it.next();
    ...
    public boolean collapseItemActionView(MenuItemImpl menuItemImpl) {
        boolean zCollapseItemActionView;
        boolean z = false;
        if (!this.mPresenters.isEmpty()) {
    ...
    public boolean performItemAction(MenuItem menuItem, MenuPresenter menuPresenter, int i) {
        ...
        if (menuItemImpl.hasCollapsibleActionView()) {
            boolean zExpandActionView = zInvoke | menuItemImpl.expandActionView();
            z = zExpandActionView;
            ...
            boolean zDispatchSubMenuSelected = zInvoke | dispatchSubMenuSelected(subMenuBuilder, menuPresenter);
            z = zDispatchSubMenuSelected;
