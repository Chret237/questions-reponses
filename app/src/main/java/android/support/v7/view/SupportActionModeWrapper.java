...
/* loaded from: classes-dex2jar.jar:android/support/v7/view/SupportActionModeWrapper.class */
public class SupportActionModeWrapper extends android.view.ActionMode {
    final Context mContext;
    final ActionMode mWrappedObject;

    /* loaded from: classes-dex2jar.jar:android/support/v7/view/SupportActionModeWrapper$CallbackWrapper.class */
    public static class CallbackWrapper implements ActionMode.Callback {
        ...
        private Menu getMenuWrapper(Menu menu) {
            ...
            Menu menuWrapSupportMenu = menu2;
            if (menu2 == null) {
                menuWrapSupportMenu = MenuWrapperFactory.wrapSupportMenu(this.mContext, (SupportMenu) menu);
