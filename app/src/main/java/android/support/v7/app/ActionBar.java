...
/* loaded from: classes-dex2jar.jar:android/support/v7/app/ActionBar.class */
public abstract class ActionBar {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/app/ActionBar$DisplayOptions.class */
    public @interface DisplayOptions {
    }

    /* loaded from: classes-dex2jar.jar:android/support/v7/app/ActionBar$LayoutParams.class */
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = 0;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0287R.styleable.ActionBarLayout);
            this.gravity = typedArrayObtainStyledAttributes.getInt(C0287R.styleable.ActionBarLayout_android_layout_gravity, 0);
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:android/support/v7/app/ActionBar$NavigationMode.class */
    public @interface NavigationMode {
    }

    /* loaded from: classes-dex2jar.jar:android/support/v7/app/ActionBar$OnMenuVisibilityListener.class */
    public interface OnMenuVisibilityListener {
        void onMenuVisibilityChanged(boolean z);
    }

    @Deprecated
    /* loaded from: classes-dex2jar.jar:android/support/v7/app/ActionBar$OnNavigationListener.class */
    public interface OnNavigationListener {
        boolean onNavigationItemSelected(int i, long j);
    }

    @Deprecated
    /* loaded from: classes-dex2jar.jar:android/support/v7/app/ActionBar$Tab.class */
    ...
    @Deprecated
    /* loaded from: classes-dex2jar.jar:android/support/v7/app/ActionBar$TabListener.class */
