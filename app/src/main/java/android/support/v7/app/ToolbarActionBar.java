...
/* loaded from: classes-dex2jar.jar:android/support/v7/app/ToolbarActionBar.class */
class ToolbarActionBar extends ActionBar {
    ...
    private final Runnable mMenuInvalidator = new Runnable(this) { // from class: android.support.v7.app.ToolbarActionBar.1
    ...
    private final Toolbar.OnMenuItemClickListener mMenuClicker = new Toolbar.OnMenuItemClickListener(this) { // from class: android.support.v7.app.ToolbarActionBar.2
        final ToolbarActionBar this$0;
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/app/ToolbarActionBar$ActionMenuPresenterCallback.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/app/ToolbarActionBar$MenuBuilderCallback.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/app/ToolbarActionBar$ToolbarCallbackWrapper.class */
