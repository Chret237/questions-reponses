...
/* loaded from: classes-dex2jar.jar:android/support/v7/util/AsyncListUtil.class */
public class AsyncListUtil<T> {
    ...
    private final ThreadUtil.BackgroundCallback<T> mBackgroundCallback = new ThreadUtil.BackgroundCallback<T>(this) { // from class: android.support.v7.util.AsyncListUtil.2
        ...
        private void requestTiles(int i, int i2, int i3, boolean z) {
            ...
            while (true) {
                ...
                this.this$0.mBackgroundProxy.loadTile(z ? (i2 + i) - i5 : i5, i3);
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/util/AsyncListUtil$DataCallback.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/util/AsyncListUtil$ViewCallback.class */
