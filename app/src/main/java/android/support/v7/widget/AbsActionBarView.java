...
/* loaded from: classes-dex2jar.jar:android/support/v7/widget/AbsActionBarView.class */
abstract class AbsActionBarView extends ViewGroup {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/widget/AbsActionBarView$VisibilityAnimListener.class */
    ...
    AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (!context.getTheme().resolveAttribute(C0287R.attr.actionBarPopupTheme, typedValue, true) || typedValue.resourceId == 0) {
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(null, C0287R.styleable.ActionBar, C0287R.attr.actionBarStyle, 0);
        setContentHeight(typedArrayObtainStyledAttributes.getLayoutDimension(C0287R.styleable.ActionBar_height, 0));
    ...
    public void postShowOverflowMenu() {
        post(new Runnable(this) { // from class: android.support.v7.widget.AbsActionBarView.1
            final AbsActionBarView this$0;
