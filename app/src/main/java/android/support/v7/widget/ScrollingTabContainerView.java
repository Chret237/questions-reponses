...
/* loaded from: classes-dex2jar.jar:android/support/v7/widget/ScrollingTabContainerView.class */
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/widget/ScrollingTabContainerView$TabAdapter.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/widget/ScrollingTabContainerView$TabClickListener.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/widget/ScrollingTabContainerView$TabView.class */
    private class TabView extends LinearLayout {
        ...
        public TabView(ScrollingTabContainerView scrollingTabContainerView, Context context, ActionBar.Tab tab, boolean z) {
            super(context, null, C0287R.attr.actionBarTabStyle);
            this.this$0 = scrollingTabContainerView;
            int[] iArr = {R.attr.background};
            this.BG_ATTRS = iArr;
            this.mTab = tab;
            TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, iArr, C0287R.attr.actionBarTabStyle, 0);
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    AppCompatTextView appCompatTextView = new AppCompatTextView(getContext(), null, C0287R.attr.actionBarTabTextStyle);
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/widget/ScrollingTabContainerView$VisibilityAnimListener.class */
    ...
    private Spinner createSpinner() {
        AppCompatSpinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0287R.attr.actionDropDownStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0287R.attr.actionBarTabBarStyle);
    ...
    public void animateToTab(int i) {
        ...
        Runnable runnable2 = new Runnable(this, childAt) { // from class: android.support.v7.widget.ScrollingTabContainerView.1
            final ScrollingTabContainerView this$0;
