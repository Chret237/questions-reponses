...
/* loaded from: classes-dex2jar.jar:android/support/v7/widget/DefaultItemAnimator.class */
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/widget/DefaultItemAnimator$ChangeInfo.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/widget/DefaultItemAnimator$MoveInfo.class */
    ...
    private void animateRemoveImpl(RecyclerView.ViewHolder viewHolder) {
        ...
        viewPropertyAnimatorAnimate.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new AnimatorListenerAdapter(this, viewHolder, viewPropertyAnimatorAnimate, view) { // from class: android.support.v7.widget.DefaultItemAnimator.4
    ...
    void animateAddImpl(RecyclerView.ViewHolder viewHolder) {
        ...
        viewPropertyAnimatorAnimate.alpha(1.0f).setDuration(getAddDuration()).setListener(new AnimatorListenerAdapter(this, viewHolder, view, viewPropertyAnimatorAnimate) { // from class: android.support.v7.widget.DefaultItemAnimator.5
            final DefaultItemAnimator this$0;
            final ViewPropertyAnimator val$animation;
            final RecyclerView.ViewHolder val$holder;
            final View val$view;
    ...
    void animateChangeImpl(ChangeInfo changeInfo) {
        ...
        if (view2 != null) {
            ...
            duration.alpha(0.0f).setListener(new AnimatorListenerAdapter(this, changeInfo, duration, view2) { // from class: android.support.v7.widget.DefaultItemAnimator.7
                final DefaultItemAnimator this$0;
        ...
        if (view != null) {
            ...
            viewPropertyAnimatorAnimate.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new AnimatorListenerAdapter(this, changeInfo, viewPropertyAnimatorAnimate, view) { // from class: android.support.v7.widget.DefaultItemAnimator.8
                final DefaultItemAnimator this$0;
                final ChangeInfo val$changeInfo;
    ...
    void animateMoveImpl(RecyclerView.ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        ...
        viewPropertyAnimatorAnimate.setDuration(getMoveDuration()).setListener(new AnimatorListenerAdapter(this, viewHolder, i5, view, i6, viewPropertyAnimatorAnimate) { // from class: android.support.v7.widget.DefaultItemAnimator.6
            final DefaultItemAnimator this$0;
            final ViewPropertyAnimator val$animation;
    ...
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z4) {
                ...
                ViewCompat.postOnAnimationDelayed(arrayList3.get(0).itemView, runnable3, removeDuration + Math.max(moveDuration, changeDuration));
            }
        }
    }
}
