...
class AdapterHelper implements OpReorderer.Callback {
    ...
    private void applyRemove(UpdateOp updateOp) {
        ...
        UpdateOp updateOpObtainUpdateOp = updateOp;
        if (i != updateOp.itemCount) {
            recycleUpdateOp(updateOp);
            updateOpObtainUpdateOp = obtainUpdateOp(2, i3, i, null);
        }
        if (z3) {
            postponeAndUpdateViewHolders(updateOpObtainUpdateOp);
        } else {
            dispatchAndUpdateViewHolders(updateOpObtainUpdateOp);
        }
    }
    ...
    private void applyUpdate(UpdateOp updateOp) {
        ...
        if (i != updateOp.itemCount) {
            ...
            recycleUpdateOp(updateOp);
            updateOpObtainUpdateOp = obtainUpdateOp(4, i3, i, obj);
        }
        if (z2) {
            postponeAndUpdateViewHolders(updateOpObtainUpdateOp);
        } else {
