...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static final int[] ATTRS = {C0287R.attr.actionBarSize, R.attr.windowContentOverlay};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new AnimatorListenerAdapter(this) { // from class: android.support.v7.widget.ActionBarOverlayLayout.1
        ...
        if (z) {
            ...
            if (this.mHasNonEmbeddedTabs) {
                ...
                if (this.mActionBarTop.getTabContainer() != null) {
                    measuredHeight = i3 + this.mActionBarHeight;
                }
            }
        } else {
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0287R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0287R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0287R.id.action_bar));
        }
    }
