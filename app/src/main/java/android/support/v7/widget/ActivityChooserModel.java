...
class ActivityChooserModel extends DataSetObservable {
        ...
        public Void doInBackground(Object... objArr) throws IOException {
            ...
            try {
                ...
                try {
                    ...
                    Log.e(ActivityChooserModel.LOG_TAG, "Error writing historical record file: " + this.this$0.mHistoryFileName, e4);
                    this.this$0.mCanReadHistoricalData = true;
                    if (fileOutputStreamOpenFileOutput == null) {
                        return null;
                    }
    ...
    private void ensureConsistentState() throws IOException {
