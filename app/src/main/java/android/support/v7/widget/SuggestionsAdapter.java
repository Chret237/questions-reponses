...
/* loaded from: classes-dex2jar.jar:android/support/v7/widget/SuggestionsAdapter.class */
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/widget/SuggestionsAdapter$ChildViewCache.class */
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0287R.id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0287R.attr.textColorSearchUrl, typedValue, true);
            ...
            if (!str.isEmpty()) {
                if ("0".equals(str)) {
                    ...
                    try {
                        ...
                        Drawable drawable2 = ContextCompat.getDrawable(this.mProviderContext, i);
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) viewNewView.findViewById(C0287R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return viewNewView;
    }
