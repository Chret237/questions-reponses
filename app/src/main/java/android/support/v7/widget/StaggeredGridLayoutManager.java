...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new Runnable(this) { // from class: android.support.v7.widget.StaggeredGridLayoutManager.1
    ...
    class Span {
        ...
        */
        public android.view.View getFocusableViewAfter(int r4, int r5) {
            /*
        ...
        if (this.mPendingSavedState.mSpanOffsetsSize > 0) {
            if (this.mPendingSavedState.mSpanOffsetsSize == this.mSpanCount) {
                for (int i = 0; i < this.mSpanCount; i++) {
                    ...
                    int endAfterPadding = i2;
                    if (i2 != Integer.MIN_VALUE) {
                        endAfterPadding = i2 + (this.mPendingSavedState.mAnchorLayoutFromEnd ? this.mPrimaryOrientation.getEndAfterPadding() : this.mPrimaryOrientation.getStartAfterPadding());
                    }
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (true) {
            ...
            boolean z3 = span == -1;
            if (z3) {
                nextSpan = layoutParams.mFullSpan ? this.mSpans[0] : getNextSpan(layoutState);
            ...
            if (layoutState.mLayoutDirection == 1) {
                int maxEnd = layoutParams.mFullSpan ? getMaxEnd(endAfterPadding) : nextSpan.getEndLine(endAfterPadding);
                int decoratedMeasurement3 = this.mPrimaryOrientation.getDecoratedMeasurement(next);
                ...
                i = decoratedMeasurement3 + maxEnd;
                decoratedMeasurement = maxEnd;
            } else {
                int minStart = layoutParams.mFullSpan ? getMinStart(endAfterPadding) : nextSpan.getStartLine(endAfterPadding);
            ...
            if (isLayoutRTL() && this.mOrientation == 1) {
                int endAfterPadding2 = layoutParams.mFullSpan ? this.mSecondaryOrientation.getEndAfterPadding() : this.mSecondaryOrientation.getEndAfterPadding() - (((this.mSpanCount - 1) - nextSpan.mIndex) * this.mSizePerSpan);
                int decoratedMeasurement4 = this.mSecondaryOrientation.getDecoratedMeasurement(next);
                int i4 = endAfterPadding2;
                i2 = endAfterPadding2 - decoratedMeasurement4;
                decoratedMeasurement2 = i4;
            } else {
                int startAfterPadding = layoutParams.mFullSpan ? this.mSecondaryOrientation.getStartAfterPadding() : (nextSpan.mIndex * this.mSizePerSpan) + this.mSecondaryOrientation.getStartAfterPadding();
            ...
            if (layoutParams.mFullSpan) {
                ...
                updateRemainingSpans(nextSpan, this.mLayoutState.mLayoutDirection, i3);
            }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void onLayoutChildren(android.support.v7.widget.RecyclerView.Recycler r6, android.support.v7.widget.RecyclerView.State r7, boolean r8) {
        /*
        ...
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if (layoutParams.mFullSpan) {
                ...
                while (true) {
                    ...
                    } else if (this.mSpans[i2].mViews.size() == 1) {
                        return;
                    } else {
                        i2++;
                    }
    ...
    private void repositionToWrapContentIfNecessary() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (decoratedMeasurement >= fMax) {
                float f = decoratedMeasurement;
                if (((LayoutParams) childAt.getLayoutParams()).isFullSpan()) {
                    f = (decoratedMeasurement * 1.0f) / this.mSpanCount;
                }
        ...
        if (this.mSecondaryOrientation.getMode() == Integer.MIN_VALUE) {
            iMin = Math.min(iRound, this.mSecondaryOrientation.getTotalSpace());
        }
        updateMeasureSpecs(iMin);
    ...
    */
    ...
    public void collectAdjacentPrefetchPositions(int i, int i2, RecyclerView.State state, RecyclerView.LayoutManager.LayoutPrefetchRegistry layoutPrefetchRegistry) {
        ...
        for (int i8 = 0; i8 < i3 && this.mLayoutState.hasMore(state); i8++) {
    ...
    int findFirstVisibleItemPositionInt() {
        ...
        return viewFindFirstVisibleItemClosestToEnd == null ? -1 : getPosition(viewFindFirstVisibleItemClosestToEnd);
    }
