...
/* loaded from: classes-dex2jar.jar:android/support/v7/widget/RoundRectDrawableWithShadow.class */
class RoundRectDrawableWithShadow extends Drawable {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/widget/RoundRectDrawableWithShadow$RoundRectHelper.class */
    interface RoundRectHelper {
        void drawRoundRect(Canvas canvas, RectF rectF, float f, Paint paint);
    }

    RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0288R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0288R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0288R.dimen.cardview_compat_inset_shadow);
    ...
    private void buildShadowCorners() {
        ...
        paint.setShader(new RadialGradient(0.0f, 0.0f, f5 + f6, new int[]{i, i, this.mShadowEndColor}, new float[]{0.0f, f4, 1.0f}, Shader.TileMode.CLAMP));
        ...
        paint2.setShader(new LinearGradient(0.0f, f8 + f9, 0.0f, f10 - f9, new int[]{i2, i2, this.mShadowEndColor}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP));
    ...
    private void setBackground(ColorStateList colorStateList) {
        ColorStateList colorStateListValueOf = colorStateList;
        if (colorStateList == null) {
            colorStateListValueOf = ColorStateList.valueOf(0);
        }
        this.mBackground = colorStateListValueOf;
        this.mPaint.setColor(colorStateListValueOf.getColorForState(getState(), this.mBackground.getDefaultColor()));
    }
    ...
    private void setShadowSize(float f, float f2) {
        ...
        this.mShadowSize = (int) ((f3 * SHADOW_MULTIPLIER) + this.mInsetShadow + 0.5f);
        this.mDirty = true;
        invalidateSelf();
    }
