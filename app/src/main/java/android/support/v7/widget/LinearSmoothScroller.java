...
/* loaded from: classes-dex2jar.jar:android/support/v7/widget/LinearSmoothScroller.class */
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    protected int getHorizontalSnapPreference() {
        ...
        return (pointF == null || pointF.x == 0.0f) ? 0 : this.mTargetVector.x > 0.0f ? 1 : -1;
    }

    protected int getVerticalSnapPreference() {
        PointF pointF = this.mTargetVector;
        return (pointF == null || pointF.y == 0.0f) ? 0 : this.mTargetVector.y > 0.0f ? 1 : -1;
    }
