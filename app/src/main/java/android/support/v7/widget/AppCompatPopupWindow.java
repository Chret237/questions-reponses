...
class AppCompatPopupWindow extends PopupWindow {
    ...
    private void init(Context context, AttributeSet attributeSet, int i, int i2) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0287R.styleable.PopupWindow, i, i2);
        if (tintTypedArrayObtainStyledAttributes.hasValue(C0287R.styleable.PopupWindow_overlapAnchor)) {
            setSupportOverlapAnchor(tintTypedArrayObtainStyledAttributes.getBoolean(C0287R.styleable.PopupWindow_overlapAnchor, false));
        }
        setBackgroundDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0287R.styleable.PopupWindow_android_popupBackground));
    ...
    public void showAsDropDown(View view, int i, int i2) {
        ...
        super.showAsDropDown(view, i, height);
    }
    ...
    public void showAsDropDown(View view, int i, int i2, int i3) {
        ...
        super.showAsDropDown(view, i, height, i3);
    }
