...
/* loaded from: classes-dex2jar.jar:android/support/v7/graphics/drawable/DrawableContainer.class */
class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/graphics/drawable/DrawableContainer$BlockInvalidateCallback.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v7/graphics/drawable/DrawableContainer$DrawableContainerState.class */
    ...
    */
    ...
    boolean selectDrawable(int i) {
        ...
        if (this.mEnterAnimationEnd != 0 || this.mExitAnimationEnd != 0) {
            ...
            if (runnable == null) {
                this.mAnimationRunnable = new Runnable(this) { // from class: android.support.v7.graphics.drawable.DrawableContainer.1
