...
public class Optimizer {
    ...
    /* JADX WARN: Removed duplicated region for block: B:217:0x068f A[PHI: r12
  0x068f: PHI (r12v14 float) = (r12v12 float), (r12v15 float) binds: [B:226:0x0725, B:215:0x0689] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    static boolean applyChainOptimized(android.support.constraint.solver.widgets.ConstraintWidgetContainer r6, android.support.constraint.solver.LinearSystem r7, int r8, int r9, android.support.constraint.solver.widgets.ChainHead r10) {
        /*
    ...
    private static boolean optimizableMatchConstraint(ConstraintWidget constraintWidget, int i) {
        ...
        if (constraintWidget.mListDimensionBehaviors[(i == 0) == true ? 1 : 0] == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
        }
        return false;
    }
