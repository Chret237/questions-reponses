...
public class ConstraintWidget {
    ...
    static /* synthetic */ class C00221 {
        ...
        static final int[] f7x1d400623;

        /* renamed from: $SwitchMap$android$support$constraint$solver$widgets$ConstraintWidget$DimensionBehaviour */
        static final int[] f8x27577131;

        /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
            jadx.core.utils.exceptions.JadxRuntimeException: Can't find top splitter block for handler:B:50:0x00ce
        ...
        static {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.constraint.solver.widgets.ConstraintWidget.C00221.m47clinit():void");
        }
    }
    ...
    */
    private void applyConstraints(android.support.constraint.solver.LinearSystem r11, boolean r12, android.support.constraint.solver.SolverVariable r13, android.support.constraint.solver.SolverVariable r14, android.support.constraint.solver.widgets.ConstraintWidget.DimensionBehaviour r15, boolean r16, android.support.constraint.solver.widgets.ConstraintAnchor r17, android.support.constraint.solver.widgets.ConstraintAnchor r18, int r19, int r20, int r21, int r22, float r23, boolean r24, boolean r25, int r26, int r27, int r28, float r29, boolean r30) {
        /*
    ...
    */
    private boolean isChainHead(int r5) {
        ...
        L56:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.constraint.solver.widgets.ConstraintWidget.isChainHead(int):boolean");
    }
    ...
    public void addToSolver(LinearSystem linearSystem) {
        ...
        if (constraintWidget != null) {
            boolean z6 = constraintWidget != null && constraintWidget.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT;
            ConstraintWidget constraintWidget2 = this.mParent;
            z2 = constraintWidget2 != null && constraintWidget2.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT;
            if (isChainHead(0)) {
            ...
            if (z6 && this.mVisibility != 8 && this.mLeft.mTarget == null && this.mRight.mTarget == null) {
        ...
        if (f <= 0.0f || this.mVisibility == 8) {
            ...
            if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT && i == 3 && i12 == 3) {
                setupDimensionRatio(z, z2, z8, z9);
            } else if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && i == 3) {
                this.mResolvedDimensionRatioSide = 0;
                i6 = (int) (this.mResolvedDimensionRatio * this.mHeight);
                if (this.mListDimensionBehaviors[1] != DimensionBehaviour.MATCH_CONSTRAINT) {
                    i11 = i12;
                    z4 = false;
                    i = 4;
                ...
                int i13 = (int) (this.mResolvedDimensionRatio * this.mWidth);
                int i14 = i;
                int i15 = i6;
                i6 = i15;
                i9 = i13;
        ...
        iArr[0] = i;
        iArr[1] = i11;
        boolean z10 = z4 && ((i3 = this.mResolvedDimensionRatioSide) == 0 || i3 == -1);
        boolean z11 = this.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT && (this instanceof ConstraintWidgetContainer);
        boolean z12 = !this.mCenter.isConnected();
        if (this.mHorizontalResolution != 2) {
            ConstraintWidget constraintWidget3 = this.mParent;
            SolverVariable solverVariableCreateObjectVariable6 = constraintWidget3 != null ? linearSystem.createObjectVariable(constraintWidget3.mRight) : null;
            ConstraintWidget constraintWidget4 = this.mParent;
            applyConstraints(linearSystem, z, constraintWidget4 != null ? linearSystem.createObjectVariable(constraintWidget4.mLeft) : null, solverVariableCreateObjectVariable6, this.mListDimensionBehaviors[0], z11, this.mLeft, this.mRight, this.f5mX, i6, this.mMinWidth, this.mMaxDimension[0], this.mHorizontalBiasPercent, z10, zIsInHorizontalChain, i, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth, this.mMatchConstraintPercentWidth, z12);
        }
        if (this.mVerticalResolution == 2) {
            return;
        }
        boolean z13 = this.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT && (this instanceof ConstraintWidgetContainer);
        boolean z14 = z4 && ((i2 = this.mResolvedDimensionRatioSide) == 1 || i2 == -1);
        if (this.mBaselineDistance <= 0) {
            ...
            if (this.mBaseline.getResolutionNode().state == 1) {
                ...
                linearSystem.addEquality(solverVariableCreateObjectVariable5, solverVariableCreateObjectVariable3, getBaselineDistance(), 6);
                if (this.mBaseline.mTarget != null) {
                    linearSystem.addEquality(solverVariableCreateObjectVariable5, linearSystem.createObjectVariable(this.mBaseline.mTarget), 0, 6);
                    z5 = false;
                }
            }
            z5 = z12;
        ...
        SolverVariable solverVariableCreateObjectVariable7 = constraintWidget5 != null ? linearSystem.createObjectVariable(constraintWidget5.mBottom) : null;
        ConstraintWidget constraintWidget6 = this.mParent;
        applyConstraints(linearSystem, z2, constraintWidget6 != null ? linearSystem.createObjectVariable(constraintWidget6.mTop) : null, solverVariableCreateObjectVariable7, this.mListDimensionBehaviors[1], z13, this.mTop, this.mBottom, this.f6mY, i9, this.mMinHeight, this.mMaxDimension[1], this.mVerticalBiasPercent, z14, z3, i11, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight, this.mMatchConstraintPercentHeight, z5);
        if (z4) {
            if (this.mResolvedDimensionRatioSide == 1) {
                linearSystem.addRatio(solverVariableCreateObjectVariable4, solverVariableCreateObjectVariable3, solverVariableCreateObjectVariable2, solverVariableCreateObjectVariable, this.mResolvedDimensionRatio, 6);
            } else {
                linearSystem.addRatio(solverVariableCreateObjectVariable2, solverVariableCreateObjectVariable, solverVariableCreateObjectVariable4, solverVariableCreateObjectVariable3, this.mResolvedDimensionRatio, 6);
            }
        }
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        switch (C00221.f7x1d400623[type.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    public boolean hasAncestor(ConstraintWidget constraintWidget) {
        ...
        for (ConstraintWidget parent2 = parent; parent2 != null; parent2 = parent2.getParent()) {
            if (parent2 == constraintWidget || parent2 == constraintWidget.getParent()) {
                return true;
            }
        }
        return false;
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:38:0x00f1 -> B:39:0x00f3). Please report as a decompilation issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void setDimensionRatio(java.lang.String r5) throws java.lang.NumberFormatException {
        /*
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int i) {
        int i2 = C00221.f7x1d400623[type.ordinal()];
        if (i2 == 1) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void updateFromSolver(android.support.constraint.solver.LinearSystem r7) {
        /*
            r6 = this;
            r0 = r7
            r1 = r6
        ...
        L7d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.constraint.solver.widgets.ConstraintWidget.updateFromSolver(android.support.constraint.solver.LinearSystem):void");
    }
