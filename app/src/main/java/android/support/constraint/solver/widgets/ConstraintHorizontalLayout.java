...
/* loaded from: classes-dex2jar.jar:android/support/constraint/solver/widgets/ConstraintHorizontalLayout.class */
public class ConstraintHorizontalLayout extends ConstraintWidgetContainer {
    private ContentAlignment mAlignment;

    /* loaded from: classes-dex2jar.jar:android/support/constraint/solver/widgets/ConstraintHorizontalLayout$ContentAlignment.class */
    ...
    public void addToSolver(LinearSystem linearSystem) {
        ...
        if (this.mChildren.size() != 0) {
            ...
            while (true) {
                constraintWidget = constraintHorizontalLayout;
                if (i >= size) {
                    break;
                }
                ...
                i++;
                constraintHorizontalLayout = constraintWidget2;
            }
            if (constraintWidget != this) {
