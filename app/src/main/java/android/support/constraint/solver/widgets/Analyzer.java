...
/* loaded from: classes-dex2jar.jar:android/support/constraint/solver/widgets/Analyzer.class */
public class Analyzer {
    ...
    public static void determineGroups(ConstraintWidgetContainer constraintWidgetContainer) {
        ...
        while (true) {
            ...
            ConstraintWidgetGroup next = it.next();
            iMax = Math.max(iMax, getMaxDimension(next, 0));
            iMax2 = Math.max(i, getMaxDimension(next, 1));
        }
        if (z) {
    ...
    private static int getMaxDimension(ConstraintWidgetGroup constraintWidgetGroup, int i) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            int i4 = i2 + 1;
            iMax = Math.max(iMax, getMaxDimensionTraversal(constraintWidget, i, constraintAnchorArr[i4].mTarget == null || !(constraintWidget.mListAnchors[i2].mTarget == null || constraintWidget.mListAnchors[i4].mTarget == null), 0));
        }
    ...
    private static int getMaxDimensionTraversal(ConstraintWidget constraintWidget, int i, boolean z, int i2) {
        ...
        while (true) {
            ...
            iMax = Math.max(i6, getMaxDimensionTraversal(((ResolutionAnchor) it.next()).myAnchor.mOwner, i, z, i11));
        }
        ...
        while (true) {
            ...
            iMax2 = Math.max(i7, getMaxDimensionTraversal(((ResolutionAnchor) it2.next()).myAnchor.mOwner, i, z, width2 + i11));
        }
        if (z2) {
        ...
        if (i == 1) {
            ...
            while (true) {
                ...
                iMax3 = i5 == 1 ? Math.max(i9, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i, z, height + i11)) : Math.max(i9, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i, z, (baselineDistance * i5) + i11));
            }
        ...
        int iMax4 = Math.max(i8, Math.max(width, i9));
        int i12 = width2 + i11;
        int i13 = i11;
        int i14 = i12;
        if (i5 == -1) {
        ...
        if (z) {
            ...
            constraintWidget.setFrame(i13, i14, i);
        } else {
        ...
        if (constraintWidget.mListAnchors[i4].mTarget != null && constraintWidget.mListAnchors[i3].mTarget != null && constraintWidget.mListAnchors[i4].mTarget.mOwner == (parent = constraintWidget.getParent()) && constraintWidget.mListAnchors[i3].mTarget.mOwner == parent) {
            constraintWidget.mBelongingGroup.addWidgetsToSet(constraintWidget, i);
        }
        return margin + iMax4;
    }
    ...
    private static int resolveDimensionRatio(ConstraintWidget constraintWidget) {
        ...
        if (constraintWidget.getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            width = (int) (constraintWidget.mDimensionRatioSide == 0 ? constraintWidget.getHeight() * constraintWidget.mDimensionRatio : constraintWidget.getHeight() / constraintWidget.mDimensionRatio);
            ...
            width = (int) (constraintWidget.mDimensionRatioSide == 1 ? constraintWidget.getWidth() * constraintWidget.mDimensionRatio : constraintWidget.getWidth() / constraintWidget.mDimensionRatio);
