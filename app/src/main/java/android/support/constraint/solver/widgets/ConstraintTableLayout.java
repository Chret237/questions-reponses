...
/* loaded from: classes-dex2jar.jar:android/support/constraint/solver/widgets/ConstraintTableLayout.class */
public class ConstraintTableLayout extends ConstraintWidgetContainer {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/constraint/solver/widgets/ConstraintTableLayout$HorizontalSlice.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/constraint/solver/widgets/ConstraintTableLayout$VerticalSlice.class */
    class VerticalSlice {
        int alignment = 1;
    ...
    public void addToSolver(LinearSystem linearSystem) {
        ...
        if (linearSystem == this.mSystem) {
            ...
            for (i = 0; i < size; i++) {
                this.mChildren.get(i).addToSolver(linearSystem);
            }
        }
    }
