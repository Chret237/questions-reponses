...
/* loaded from: classes-dex2jar.jar:android/support/constraint/solver/widgets/Barrier.class */
    ...
    public void resolve() {
        ...
        while (true) {
            ...
            if (i2 >= size) {
                ...
                int i3 = this.mBarrierType;
                if (i3 == 0) {
                    this.mRight.getResolutionNode().resolve(resolutionAnchor, f2);
                    return;
                }
                if (i3 == 1) {
                    this.mLeft.getResolutionNode().resolve(resolutionAnchor, f2);
                    return;
                } else if (i3 == 2) {
                    this.mBottom.getResolutionNode().resolve(resolutionAnchor, f2);
                    return;
                } else {
                    if (i3 != 3) {
                        return;
                    }
                    this.mTop.getResolutionNode().resolve(resolutionAnchor, f2);
                    return;
                }
            }
            ...
            if (i4 == 0 || i4 == 2) {
                f = f2;
                if (resolutionAnchor2.resolvedOffset < f2) {
