...
/* loaded from: classes-dex2jar.jar:android/support/graphics/drawable/AnimatedVectorDrawableCompat.class */
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/graphics/drawable/AnimatedVectorDrawableCompat$AnimatedVectorDrawableCompatState.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/graphics/drawable/AnimatedVectorDrawableCompat$AnimatedVectorDrawableDelegateState.class */
    ...
    private AnimatedVectorDrawableCompat(Context context, AnimatedVectorDrawableCompatState animatedVectorDrawableCompatState, Resources resources) {
        ...
        this.mCallback = new Drawable.Callback(this) { // from class: android.support.graphics.drawable.AnimatedVectorDrawableCompat.1
    ...
    public void registerAnimationCallback(Animatable2Compat.AnimationCallback animationCallback) {
        ...
        if (this.mAnimatorListener == null) {
            this.mAnimatorListener = new AnimatorListenerAdapter(this) { // from class: android.support.graphics.drawable.AnimatedVectorDrawableCompat.2
                final AnimatedVectorDrawableCompat this$0;
