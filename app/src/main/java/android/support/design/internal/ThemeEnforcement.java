...
public final class ThemeEnforcement {
    ...
    private static final int[] APPCOMPAT_CHECK_ATTRS = {C0029R.attr.colorPrimary};
    private static final int[] MATERIAL_CHECK_ATTRS = {C0029R.attr.colorSecondary};
    ...
    private static void checkCompatibleTheme(Context context, AttributeSet attributeSet, int i, int i2) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0029R.styleable.ThemeEnforcement, i, i2);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(C0029R.styleable.ThemeEnforcement_enforceMaterialTheme, false);
    ...
    private static void checkTextAppearance(Context context, AttributeSet attributeSet, int[] iArr, int i, int i2, int... iArr2) {
        ...
        if (!typedArrayObtainStyledAttributes.getBoolean(C0029R.styleable.ThemeEnforcement_enforceTextAppearance, false)) {
            typedArrayObtainStyledAttributes.recycle();
            return;
        }
        if (iArr2 != null && iArr2.length != 0) {
            zIsCustomTextAppearanceValid = isCustomTextAppearanceValid(context, attributeSet, iArr, i, i2, iArr2);
        } else if (typedArrayObtainStyledAttributes.getResourceId(C0029R.styleable.ThemeEnforcement_android_textAppearance, -1) != -1) {
