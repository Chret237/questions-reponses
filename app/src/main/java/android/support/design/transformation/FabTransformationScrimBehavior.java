...
/* loaded from: classes-dex2jar.jar:android/support/design/transformation/FabTransformationScrimBehavior.class */
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    protected AnimatorSet onCreateExpandedStateChangeAnimation(View view, View view2, boolean z, boolean z2) {
        ...
        animatorSet.addListener(new AnimatorListenerAdapter(this, z, view2) { // from class: android.support.design.transformation.FabTransformationScrimBehavior.1
