...
/* loaded from: classes-dex2jar.jar:android/support/design/circularreveal/CircularRevealHelper.class */
public class CircularRevealHelper {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/design/circularreveal/CircularRevealHelper$Delegate.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/design/circularreveal/CircularRevealHelper$Strategy.class */
    ...
    public void buildCircularRevealCache() {
        if (STRATEGY == 0) {
            ...
            Bitmap bitmapCreateBitmap = drawingCache;
            if (drawingCache == null) {
                bitmapCreateBitmap = drawingCache;
                if (this.view.getWidth() != 0) {
                    bitmapCreateBitmap = drawingCache;
                    if (this.view.getHeight() != 0) {
                        bitmapCreateBitmap = Bitmap.createBitmap(this.view.getWidth(), this.view.getHeight(), Bitmap.Config.ARGB_8888);
                        this.view.draw(new Canvas(bitmapCreateBitmap));
                    }
                }
            }
            if (bitmapCreateBitmap != null) {
                this.revealPaint.setShader(new BitmapShader(bitmapCreateBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP));
            }
