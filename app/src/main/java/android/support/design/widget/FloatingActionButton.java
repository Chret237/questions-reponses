...
/* loaded from: classes-dex2jar.jar:android/support/design/widget/FloatingActionButton.class */
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/design/widget/FloatingActionButton$BaseBehavior.class */
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public BaseBehavior(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0029R.styleable.FloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = typedArrayObtainStyledAttributes.getBoolean(C0029R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
    ...
    /* loaded from: classes-dex2jar.jar:android/support/design/widget/FloatingActionButton$Behavior.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/design/widget/FloatingActionButton$OnVisibilityChangedListener.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/design/widget/FloatingActionButton$ShadowDelegateImpl.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/design/widget/FloatingActionButton$Size.class */
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0029R.attr.floatingActionButtonStyle);
    }
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C0029R.styleable.FloatingActionButton, i, C0029R.style.Widget_Design_FloatingActionButton, new int[0]);
        this.backgroundTint = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C0029R.styleable.FloatingActionButton_backgroundTint);
        this.backgroundTintMode = ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(C0029R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.rippleColor = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C0029R.styleable.FloatingActionButton_rippleColor);
        this.size = typedArrayObtainStyledAttributes.getInt(C0029R.styleable.FloatingActionButton_fabSize, -1);
        this.customSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0029R.styleable.FloatingActionButton_fabCustomSize, 0);
        this.borderWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0029R.styleable.FloatingActionButton_borderWidth, 0);
        float dimension = typedArrayObtainStyledAttributes.getDimension(C0029R.styleable.FloatingActionButton_elevation, 0.0f);
        float dimension2 = typedArrayObtainStyledAttributes.getDimension(C0029R.styleable.FloatingActionButton_hoveredFocusedTranslationZ, 0.0f);
        float dimension3 = typedArrayObtainStyledAttributes.getDimension(C0029R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.compatPadding = typedArrayObtainStyledAttributes.getBoolean(C0029R.styleable.FloatingActionButton_useCompatPadding, false);
        this.maxImageSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0029R.styleable.FloatingActionButton_maxImageSize, 0);
        MotionSpec motionSpecCreateFromAttribute = MotionSpec.createFromAttribute(context, typedArrayObtainStyledAttributes, C0029R.styleable.FloatingActionButton_showMotionSpec);
        MotionSpec motionSpecCreateFromAttribute2 = MotionSpec.createFromAttribute(context, typedArrayObtainStyledAttributes, C0029R.styleable.FloatingActionButton_hideMotionSpec);
        typedArrayObtainStyledAttributes.recycle();
    ...
    private int getSizeDimension(int i) {
        ...
        if (i != -1) {
            return i != 1 ? resources.getDimensionPixelSize(C0029R.dimen.design_fab_size_normal) : resources.getDimensionPixelSize(C0029R.dimen.design_fab_size_mini);
        }
    ...
    private FloatingActionButtonImpl.InternalVisibilityChangedListener wrapOnVisibilityChangedListener(OnVisibilityChangedListener onVisibilityChangedListener) {
        ...
        return new FloatingActionButtonImpl.InternalVisibilityChangedListener(this, onVisibilityChangedListener) { // from class: android.support.design.widget.FloatingActionButton.1
            final FloatingActionButton this$0;
