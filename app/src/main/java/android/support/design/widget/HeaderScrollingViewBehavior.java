...
/* loaded from: classes-dex2jar.jar:android/support/design/widget/HeaderScrollingViewBehavior.class */
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    final int getOverlapPixelsForOffset(View view) {
        ...
        if (this.overlayTop != 0) {
            ...
            iClamp = android.support.v4.math.MathUtils.clamp((int) (overlapRatioForOffset * i), 0, i);
        }
        return iClamp;
    }
    ...
    public boolean onMeasureChild(CoordinatorLayout coordinatorLayout, View view, int i, int i2, int i3, int i4) {
        ...
        coordinatorLayout.onMeasureChild(view, i, i2, View.MeasureSpec.makeMeasureSpec((height - measuredHeight) + getScrollRange(viewFindFirstDependency), i5 == -1 ? 1073741824 : Integer.MIN_VALUE), i4);
        return true;
    }
