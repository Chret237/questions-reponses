...
/* loaded from: classes-dex2jar.jar:android/support/design/widget/SnackbarManager.class */
class SnackbarManager {
    ...
    private final Handler handler = new Handler(Looper.getMainLooper(), new Handler.Callback(this) { // from class: android.support.design.widget.SnackbarManager.1
    ...
    /* loaded from: classes-dex2jar.jar:android/support/design/widget/SnackbarManager$Callback.class */
    interface Callback {
        void dismiss(int i);
    ...
    /* loaded from: classes-dex2jar.jar:android/support/design/widget/SnackbarManager$SnackbarRecord.class */
