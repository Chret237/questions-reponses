...
/* loaded from: classes-dex2jar.jar:android/support/design/button/MaterialButtonHelper.class */
class MaterialButtonHelper {
    ...
    public void loadFromAttributes(TypedArray typedArray) {
        int colorForState = 0;
        this.insetLeft = typedArray.getDimensionPixelOffset(C0029R.styleable.MaterialButton_android_insetLeft, 0);
        this.insetRight = typedArray.getDimensionPixelOffset(C0029R.styleable.MaterialButton_android_insetRight, 0);
        this.insetTop = typedArray.getDimensionPixelOffset(C0029R.styleable.MaterialButton_android_insetTop, 0);
        this.insetBottom = typedArray.getDimensionPixelOffset(C0029R.styleable.MaterialButton_android_insetBottom, 0);
        this.cornerRadius = typedArray.getDimensionPixelSize(C0029R.styleable.MaterialButton_cornerRadius, 0);
        this.strokeWidth = typedArray.getDimensionPixelSize(C0029R.styleable.MaterialButton_strokeWidth, 0);
        this.backgroundTintMode = ViewUtils.parseTintMode(typedArray.getInt(C0029R.styleable.MaterialButton_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.backgroundTint = MaterialResources.getColorStateList(this.materialButton.getContext(), typedArray, C0029R.styleable.MaterialButton_backgroundTint);
        this.strokeColor = MaterialResources.getColorStateList(this.materialButton.getContext(), typedArray, C0029R.styleable.MaterialButton_strokeColor);
        this.rippleColor = MaterialResources.getColorStateList(this.materialButton.getContext(), typedArray, C0029R.styleable.MaterialButton_rippleColor);
        ...
        if (colorStateList != null) {
            colorForState = colorStateList.getColorForState(this.materialButton.getDrawableState(), 0);
        }
    ...
    void setCornerRadius(int i) {
        ...
        if (this.cornerRadius != i) {
            ...
            if (Build.VERSION.SDK_INT == 21) {
                ...
                gradientDrawableUnwrapBackgroundDrawable.setCornerRadius(f2);
