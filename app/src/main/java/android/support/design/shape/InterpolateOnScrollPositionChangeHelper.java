...
/* loaded from: classes-dex2jar.jar:android/support/design/shape/InterpolateOnScrollPositionChangeHelper.class */
public class InterpolateOnScrollPositionChangeHelper {
    ...
    private final ViewTreeObserver.OnScrollChangedListener scrollChangedListener = new ViewTreeObserver.OnScrollChangedListener(this) { // from class: android.support.design.shape.InterpolateOnScrollPositionChangeHelper.1
