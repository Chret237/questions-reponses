...
/* loaded from: classes-dex2jar.jar:android/support/design/shape/MaterialShapeDrawable.class */
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable {
    ...
    private void setCornerPathAndTransform(int i, int i2, int i3) {
        ...
        float fAngleOfEdge = angleOfEdge(((i - 1) + 4) % 4, i2, i3);
        this.cornerTransforms[i].reset();
        this.cornerTransforms[i].setTranslate(this.pointF.x, this.pointF.y);
        this.cornerTransforms[i].preRotate((float) Math.toDegrees(fAngleOfEdge + 1.5707964f));
    }
