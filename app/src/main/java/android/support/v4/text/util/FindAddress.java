...
/* loaded from: classes-dex2jar.jar:android/support/v4/text/util/FindAddress.class */
class FindAddress {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/text/util/FindAddress$ZipRange.class */
    ...
    */
    private static int attemptMatch(java.lang.String r4, java.util.regex.MatchResult r5) {
        /*
    ...
    private static boolean checkHouseNumber(String str) throws NumberFormatException {
        ...
        int i6 = i5 % 10;
        if (i6 == 1) {
            return lowerCase.equals(i5 % 100 != 11 ? "st" : "th");
        }
        if (i6 == 2) {
            return lowerCase.equals(i5 % 100 != 12 ? "nd" : "th");
        }
        if (i6 != 3) {
            return lowerCase.equals("th");
        }
        return lowerCase.equals(i5 % 100 != 13 ? "rd" : "th");
    }
    ...
    private static boolean isValidZipCode(String str, MatchResult matchResult) {
        ...
        if (sZipCodeRe.matcher(str).matches()) {
            z = false;
            if (sStateZipCodeRanges[i].matches(str)) {
                z = true;
            }
        }
        return z;
