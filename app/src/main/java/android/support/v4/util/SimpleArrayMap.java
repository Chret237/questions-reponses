...
/* loaded from: classes-dex2jar.jar:android/support/v4/util/SimpleArrayMap.class */
public class SimpleArrayMap<K, V> {
    ...
    public V get(Object obj) {
        ...
        return iIndexOfKey >= 0 ? this.mArray[(iIndexOfKey << 1) + 1] : null;
    }
    ...
    int indexOfNull() {
        ...
        if (iBinarySearchHashes >= 0 && this.mArray[iBinarySearchHashes << 1] != null) {
            ...
            do {
                iBinarySearchHashes--;
                if (iBinarySearchHashes < 0 || this.mHashes[iBinarySearchHashes] != 0) {
                    return i2 ^ (-1);
                }
            } while (this.mArray[iBinarySearchHashes << 1] != null);
            return iBinarySearchHashes;
        }
        return iBinarySearchHashes;
    }
        ...
        if (i4 <= 1) {
            ...
            if (iArr.length <= 8 || i4 >= iArr.length / 3) {
                ...
                if (i < i5) {
                    ...
                    System.arraycopy(objArr4, i10 << 1, this.mArray, i3, i11 << 1);
                }
            }
            i2 = i5;
        }
