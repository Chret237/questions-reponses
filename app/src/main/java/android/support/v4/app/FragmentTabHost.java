...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/FragmentTabHost$DummyTabFactory.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/FragmentTabHost$TabInfo.class */
    ...
    private FragmentTransaction doTabChanged(String str, FragmentTransaction fragmentTransaction) {
        ...
        if (this.mLastTab != tabInfoForTag) {
            ...
            if (tabInfo != null && tabInfo.fragment != null) {
                fragmentTransactionBeginTransaction.detach(this.mLastTab.fragment);
            }
            if (tabInfoForTag != null) {
                if (tabInfoForTag.fragment == null) {
                    ...
                    fragmentTransactionBeginTransaction.add(this.mContainerId, tabInfoForTag.fragment, tabInfoForTag.tag);
                } else {
                    fragmentTransactionBeginTransaction.attach(tabInfoForTag.fragment);
                }
            }
    ...
    protected void onAttachedToWindow() {
        ...
        this.mAttached = true;
        FragmentTransaction fragmentTransactionDoTabChanged = doTabChanged(currentTabTag, fragmentTransaction);
