...
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    public TaskStackBuilder addNextIntentWithParentStack(Intent intent) {
        ...
        if (component == null) {
            componentNameResolveActivity = intent.resolveActivity(this.mSourceContext.getPackageManager());
        }
        if (componentNameResolveActivity != null) {
            addParentStack(componentNameResolveActivity);
        }
    ...
    public TaskStackBuilder addParentStack(Activity activity) {
        ...
        if (parentActivityIntent != null) {
            ...
            ComponentName componentNameResolveActivity = component;
            if (component == null) {
                componentNameResolveActivity = parentActivityIntent.resolveActivity(this.mSourceContext.getPackageManager());
            }
            addParentStack(componentNameResolveActivity);
