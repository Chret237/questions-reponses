...
/* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat.class */
public class NotificationCompat {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$Action.class */
    public static class Action {
        ...
        /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$Action$Builder.class */
        ...
        /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$Action$Extender.class */
        public interface Extender {
            Builder extend(Builder builder);
        }

        @Retention(RetentionPolicy.SOURCE)
        /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$Action$SemanticAction.class */
        public @interface SemanticAction {
        }

        /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$Action$WearableExtender.class */
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m142clone() {
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$BadgeIconType.class */
    public @interface BadgeIconType {
    }

    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$BigPictureStyle.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$BigTextStyle.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$Builder.class */
    public static class Builder {
        ...
        protected static CharSequence limitCharSequenceLength(CharSequence charSequence) {
            ...
            if (charSequence.length() > MAX_CHARSEQUENCE_LENGTH) {
                charSequenceSubSequence = charSequence.subSequence(0, MAX_CHARSEQUENCE_LENGTH);
            }
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) throws Resources.NotFoundException {
            ...
            if (bitmap != null) {
                if (Build.VERSION.SDK_INT >= 27) {
                    ...
                    Double.isNaN(height);
                    bitmapCreateScaledBitmap = Bitmap.createScaledBitmap(bitmap, iCeil, (int) Math.ceil(height * dMin), true);
                }
            }
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$CarExtender.class */
    public static final class CarExtender implements Extender {
        ...
        /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$CarExtender$UnreadConversation.class */
        public static class UnreadConversation {
            ...
            /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$CarExtender$UnreadConversation$Builder.class */
            public static class Builder {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle) {
            ...
            if (parcelableArray != null) {
                ...
                while (true) {
                    ...
                    strArr[i] = ((Bundle) parcelableArray[i]).getString(KEY_TEXT);
                    if (strArr[i] == null) {
                        z = false;
                        break;
                    }
            ...
            if (stringArray != null) {
                if (stringArray.length != 1) {
                    ...
                    unreadConversation = new UnreadConversation(strArr, remoteInput2, pendingIntent2, pendingIntent, stringArray, bundle.getLong(KEY_TIMESTAMP));
                }
            }
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$DecoratedCustomViewStyle.class */
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            boolean z2;
            int iMin;
            RemoteViews remoteViewsApplyStandardTemplate = applyStandardTemplate(true, C0017R.layout.notification_template_custom_big, false);
            remoteViewsApplyStandardTemplate.removeAllViews(C0017R.id.actions);
            if (z && this.mBuilder.mActions != null && (iMin = Math.min(this.mBuilder.mActions.size(), 3)) > 0) {
                ...
                while (true) {
                    ...
                    remoteViewsApplyStandardTemplate.addView(C0017R.id.actions, generateActionButton(this.mBuilder.mActions.get(i)));
                    i++;
                }
            } else {
                z2 = false;
            ...
            int i2 = z2 ? 0 : 8;
            remoteViewsApplyStandardTemplate.setViewVisibility(C0017R.id.actions, i2);
            remoteViewsApplyStandardTemplate.setViewVisibility(C0017R.id.action_divider, i2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0017R.layout.notification_action_tombstone : C0017R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0017R.id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0017R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0017R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0017R.id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0017R.id.action_container, action.title);
            }
            return remoteViews;
        }
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$Extender.class */
    public interface Extender {
        Builder extend(Builder builder);
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$GroupAlertBehavior.class */
    public @interface GroupAlertBehavior {
    }

    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$InboxStyle.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$MessagingStyle.class */
    public static class MessagingStyle extends Style {
        ...
        /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$MessagingStyle$Message.class */
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            if (TextUtils.isEmpty(name)) {
                CharSequence name2 = this.mUser.getName();
                color = i;
                charSequence = name2;
                if (z) {
                    color = i;
            ...
            CharSequence charSequenceUnicodeWrap = bidiFormatter.unicodeWrap(charSequence);
            ...
            spannableStringBuilder.append((CharSequence) "  ").append(bidiFormatter.unicodeWrap(message.getText() == null ? BuildConfig.FLAVOR : message.getText()));
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$NotificationVisibility.class */
    public @interface NotificationVisibility {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$StreamType.class */
    public @interface StreamType {
    }

    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$Style.class */
    public static abstract class Style {
        ...
        private int calculateTopPadding() throws Resources.NotFoundException {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0017R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0017R.dimen.notification_top_pad_large_text);
        ...
        private Bitmap createColoredBitmap(int i, int i2, int i3) throws Resources.NotFoundException {
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) throws Resources.NotFoundException {
            int i5 = C0017R.drawable.notification_icon_background;
            int i6 = i4;
            if (i4 == 0) {
                i6 = 0;
            }
            Bitmap bitmapCreateColoredBitmap = createColoredBitmap(i5, i6, i2);
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0017R.id.title, 8);
            remoteViews.setViewVisibility(C0017R.id.text2, 8);
            remoteViews.setViewVisibility(C0017R.id.text, 8);
        }
        ...
        */
        public android.widget.RemoteViews applyStandardTemplate(boolean r11, int r12, boolean r13) throws android.content.res.Resources.NotFoundException {
            /*
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0017R.id.notification_main_column);
            remoteViews.addView(C0017R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0017R.id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0017R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/NotificationCompat$WearableExtender.class */
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m143clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i = 0; i < remoteInputs.length; i++) {
                ...
                remoteInputArr[i] = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), remoteInput.getExtras(), null);
            }
        }
