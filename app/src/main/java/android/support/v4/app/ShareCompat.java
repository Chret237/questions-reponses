...
/* loaded from: classes-dex2jar.jar:android/support/v4/app/ShareCompat.class */
public final class ShareCompat {
    public static final String EXTRA_CALLING_ACTIVITY = "android.support.v4.app.EXTRA_CALLING_ACTIVITY";
    public static final String EXTRA_CALLING_PACKAGE = "android.support.v4.app.EXTRA_CALLING_PACKAGE";
    private static final String HISTORY_FILENAME_PREFIX = ".sharecompat_";

    /* loaded from: classes-dex2jar.jar:android/support/v4/app/ShareCompat$IntentBuilder.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/ShareCompat$IntentReader.class */
        ...
        public String getHtmlText() {
            ...
            if (stringExtra == null) {
                ...
                if (text instanceof Spanned) {
                    string = Html.toHtml((Spanned) text);
                } else {
                    string = stringExtra;
                    if (text != null) {
    ...
    public static String getCallingPackage(Activity activity) {
        ...
        String stringExtra = callingPackage;
        if (callingPackage == null) {
            stringExtra = activity.getIntent().getStringExtra(EXTRA_CALLING_PACKAGE);
        }
        return stringExtra;
    }
}
