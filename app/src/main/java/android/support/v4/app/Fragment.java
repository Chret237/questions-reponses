...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/Fragment$AnimationInfo.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/Fragment$InstantiationException.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/Fragment$OnStartEnterTransitionListener.class */
    ...
    public final LayoutInflater getLayoutInflater() {
        ...
        LayoutInflater layoutInflaterPerformGetLayoutInflater = layoutInflater;
        if (layoutInflater == null) {
            layoutInflaterPerformGetLayoutInflater = performGetLayoutInflater(null);
        }
        return layoutInflaterPerformGetLayoutInflater;
    }
    ...
    void instantiateChildFragmentManager() {
        ...
        fragmentManagerImpl.attachController(this.mHost, new FragmentContainer(this) { // from class: android.support.v4.app.Fragment.2
    ...
    boolean performCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        boolean zDispatchCreateOptionsMenu = false;
        if (!this.mHidden) {
            boolean z = false;
            if (this.mHasMenu) {
                z = false;
            ...
            FragmentManagerImpl fragmentManagerImpl = this.mChildFragmentManager;
            zDispatchCreateOptionsMenu = z;
            if (fragmentManagerImpl != null) {
                zDispatchCreateOptionsMenu = z | fragmentManagerImpl.dispatchCreateOptionsMenu(menu, menuInflater);
            }
        }
        return zDispatchCreateOptionsMenu;
    }
    ...
    void performCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mViewLifecycleOwner = new LifecycleOwner(this) { // from class: android.support.v4.app.Fragment.3
            final Fragment this$0;
    ...
    boolean performPrepareOptionsMenu(Menu menu) {
        boolean zDispatchPrepareOptionsMenu = false;
        if (!this.mHidden) {
            boolean z = false;
            if (this.mHasMenu) {
                z = false;
            ...
            FragmentManagerImpl fragmentManagerImpl = this.mChildFragmentManager;
            zDispatchPrepareOptionsMenu = z;
            if (fragmentManagerImpl != null) {
                zDispatchPrepareOptionsMenu = z | fragmentManagerImpl.dispatchPrepareOptionsMenu(menu);
            }
        }
        return zDispatchPrepareOptionsMenu;
    }
    ...
    public void setTargetFragment(Fragment fragment, int i) {
        ...
        while (true) {
            ...
            if (fragment2 == null) {
                ...
                targetFragment = fragment2.getTargetFragment();
            }
        }
    }
    ...
    public void startPostponedEnterTransition() {
        ...
        if (fragmentManagerImpl == null || fragmentManagerImpl.mHost == null) {
            ...
            this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new Runnable(this) { // from class: android.support.v4.app.Fragment.1
                final Fragment this$0;
