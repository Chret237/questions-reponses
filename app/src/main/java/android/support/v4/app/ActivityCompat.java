...
/* loaded from: classes-dex2jar.jar:android/support/v4/app/ActivityCompat.class */
public class ActivityCompat extends ContextCompat {
    private static PermissionCompatDelegate sDelegate;

    /* loaded from: classes-dex2jar.jar:android/support/v4/app/ActivityCompat$OnRequestPermissionsResultCallback.class */
    public interface OnRequestPermissionsResultCallback {
        void onRequestPermissionsResult(int i, String[] strArr, int[] iArr);
    }

    /* loaded from: classes-dex2jar.jar:android/support/v4/app/ActivityCompat$PermissionCompatDelegate.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/ActivityCompat$RequestPermissionsRequestCodeValidator.class */
    public interface RequestPermissionsRequestCodeValidator {
        void validateRequestPermissionsRequestCode(int i);
    }

    /* loaded from: classes-dex2jar.jar:android/support/v4/app/ActivityCompat$SharedElementCallback21Impl.class */
    private static class SharedElementCallback21Impl extends android.app.SharedElementCallback {
        ...
        public void onSharedElementsArrived(List<String> list, List<View> list2, SharedElementCallback.OnSharedElementsReadyListener onSharedElementsReadyListener) {
            this.mCallback.onSharedElementsArrived(list, list2, new SharedElementCallback.OnSharedElementsReadyListener(this, onSharedElementsReadyListener) { // from class: android.support.v4.app.ActivityCompat.SharedElementCallback21Impl.1
    ...
    public static void requestPermissions(Activity activity, String[] strArr, int i) {
        ...
        if (permissionCompatDelegate == null || !permissionCompatDelegate.requestPermissions(activity, strArr, i)) {
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                new Handler(Looper.getMainLooper()).post(new Runnable(strArr, activity, i) { // from class: android.support.v4.app.ActivityCompat.1
