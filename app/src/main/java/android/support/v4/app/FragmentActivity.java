...
/* loaded from: classes-dex2jar.jar:android/support/v4/app/FragmentActivity.class */
public class FragmentActivity extends SupportActivity implements ViewModelStoreOwner, ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/FragmentActivity$HostCallbacks.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/app/FragmentActivity$NonConfigurationInstances.class */
        ...
        for (Fragment fragment : fragmentManager.getFragments()) {
            if (fragment != null) {
                ...
                if (fragmentManagerPeekChildFragmentManager != null) {
                    zMarkState = z | markState(fragmentManagerPeekChildFragmentManager, state);
                }
            }
        }
        return zMarkState;
