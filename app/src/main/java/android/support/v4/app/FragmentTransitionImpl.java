...
/* loaded from: classes-dex2jar.jar:android/support/v4/app/FragmentTransitionImpl.class */
public abstract class FragmentTransitionImpl {
    ...
    void scheduleNameReset(ViewGroup viewGroup, ArrayList<View> arrayList, Map<String, String> map) {
        OneShotPreDrawListener.add(viewGroup, new Runnable(this, arrayList, map) { // from class: android.support.v4.app.FragmentTransitionImpl.3
    ...
    void setNameOverridesOrdered(View view, ArrayList<View> arrayList, Map<String, String> map) {
        OneShotPreDrawListener.add(view, new Runnable(this, arrayList, map) { // from class: android.support.v4.app.FragmentTransitionImpl.2
            final FragmentTransitionImpl this$0;
            final Map val$nameOverrides;
            final ArrayList val$sharedElementsIn;
    ...
    void setNameOverridesReordered(View view, ArrayList<View> arrayList, ArrayList<View> arrayList2, ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        OneShotPreDrawListener.add(view, new Runnable(this, size, arrayList2, arrayList3, arrayList, arrayList4) { // from class: android.support.v4.app.FragmentTransitionImpl.1
            final FragmentTransitionImpl this$0;
