...
/* loaded from: classes-dex2jar.jar:android/support/v4/view/accessibility/AccessibilityWindowInfoCompat.class */
public class AccessibilityWindowInfoCompat {
    ...
    public static AccessibilityWindowInfoCompat obtain(AccessibilityWindowInfoCompat accessibilityWindowInfoCompat) {
        AccessibilityWindowInfoCompat accessibilityWindowInfoCompatWrapNonNullInstance = null;
        if (Build.VERSION.SDK_INT >= 21) {
            accessibilityWindowInfoCompatWrapNonNullInstance = accessibilityWindowInfoCompat == null ? null : wrapNonNullInstance(AccessibilityWindowInfo.obtain((AccessibilityWindowInfo) accessibilityWindowInfoCompat.mInfo));
        }
        return accessibilityWindowInfoCompatWrapNonNullInstance;
    }
