...
/* loaded from: classes-dex2jar.jar:android/support/v4/view/MenuItemCompat.class */
public final class MenuItemCompat {
    ...
    @Deprecated
    /* loaded from: classes-dex2jar.jar:android/support/v4/view/MenuItemCompat$OnActionExpandListener.class */
    ...
    public static MenuItem setOnActionExpandListener(MenuItem menuItem, OnActionExpandListener onActionExpandListener) {
        return menuItem.setOnActionExpandListener(new MenuItem.OnActionExpandListener(onActionExpandListener) { // from class: android.support.v4.view.MenuItemCompat.1
