...
/* loaded from: classes-dex2jar.jar:android/support/v4/view/NestedScrollingChildHelper.class */
public class NestedScrollingChildHelper {
    ...
    */
    public boolean dispatchNestedPreScroll(int r8, int r9, int[] r10, int[] r11, int r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.NestedScrollingChildHelper.dispatchNestedPreScroll(int, int, int[], int[], int):boolean");
    }
