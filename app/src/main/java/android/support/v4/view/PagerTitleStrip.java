...
public class PagerTitleStrip extends ViewGroup {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/view/PagerTitleStrip$PageListener.class */
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/view/PagerTitleStrip$SingleLineAllCapsTransform.class */
    ...
    void updateTextPositions(int i, float f, boolean z) {
        ...
        int iMin2 = Math.min(paddingLeft, (i8 - this.mScaledTextSpacing) - measuredWidth);
        TextView textView22 = this.mPrevText;
        textView22.layout(iMin2, i3, measuredWidth + iMin2, textView22.getMeasuredHeight() + i3);
        int iMax32 = Math.max((width - paddingRight) - measuredWidth3, i9 + this.mScaledTextSpacing);
