...
/* loaded from: classes-dex2jar.jar:android/support/v4/view/ViewCompat.class */
public class ViewCompat {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/view/ViewCompat$FocusDirection.class */
    public @interface FocusDirection {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:android/support/v4/view/ViewCompat$FocusRealDirection.class */
    public @interface FocusRealDirection {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:android/support/v4/view/ViewCompat$FocusRelativeDirection.class */
    public @interface FocusRelativeDirection {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:android/support/v4/view/ViewCompat$NestedScrollType.class */
    public @interface NestedScrollType {
    }

    /* loaded from: classes-dex2jar.jar:android/support/v4/view/ViewCompat$OnUnhandledKeyEventListenerCompat.class */
    public interface OnUnhandledKeyEventListenerCompat {
        boolean onUnhandledKeyEvent(View view, KeyEvent keyEvent);
    }

    /* loaded from: classes-dex2jar.jar:android/support/v4/view/ViewCompat$OnUnhandledKeyEventListenerWrapper.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:android/support/v4/view/ViewCompat$ScrollAxis.class */
    public @interface ScrollAxis {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: classes-dex2jar.jar:android/support/v4/view/ViewCompat$ScrollIndicators.class */
    public @interface ScrollIndicators {
    }

    /* loaded from: classes-dex2jar.jar:android/support/v4/view/ViewCompat$UnhandledKeyEventManager.class */
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m6at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0017R.id.tag_unhandled_key_event_manager);
            ...
            if (unhandledKeyEventManager == null) {
                ...
                view.setTag(C0017R.id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
            }
        ...
        private boolean onUnhandledKeyEvent(View view, KeyEvent keyEvent) {
            ArrayList arrayList = (ArrayList) view.getTag(C0017R.id.tag_unhandled_key_listeners);
            if (arrayList == null) {
                return false;
            }
        ...
        boolean preDispatch(KeyEvent keyEvent) {
            ...
            if (keyEvent.getAction() == 1) {
                int iIndexOfKey = capturedKeys.indexOfKey(keyEvent.getKeyCode());
            ...
            WeakReference<View> weakReference2 = weakReferenceValueAt;
    ...
    public static void addOnUnhandledKeyEventListener(View view, OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (Build.VERSION.SDK_INT >= 28) {
            Map map = (Map) view.getTag(C0017R.id.tag_unhandled_key_listeners);
            Map arrayMap = map;
            if (map == null) {
                arrayMap = new ArrayMap();
                view.setTag(C0017R.id.tag_unhandled_key_listeners, arrayMap);
            }
        ...
        if (arrayList == null) {
            ...
            view.setTag(C0017R.id.tag_unhandled_key_listeners, arrayList2);
        }
    ...
    static boolean dispatchUnhandledKeyEventBeforeCallback(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m6at(view).dispatch(view, keyEvent);
    }
    ...
    static boolean dispatchUnhandledKeyEventBeforeHierarchy(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m6at(view).preDispatch(keyEvent);
    }
    ...
    public static WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
        ...
        if (windowInsetsOnApplyWindowInsets != windowInsets) {
            windowInsets2 = new WindowInsets(windowInsetsOnApplyWindowInsets);
        }
        return WindowInsetsCompat.wrap(windowInsets2);
    }
    ...
    public static void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        if (Build.VERSION.SDK_INT >= 21) {
            if (onApplyWindowInsetsListener == null) {
                ...
                view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener(onApplyWindowInsetsListener) { // from class: android.support.v4.view.ViewCompat.1
                    ...
                    public WindowInsets onApplyWindowInsets(View view2, WindowInsets windowInsets) {
                        return (WindowInsets) WindowInsetsCompat.unwrap(this.val$listener.onApplyWindowInsets(view2, WindowInsetsCompat.wrap(windowInsets)));
                    }
                });
            }
        }
