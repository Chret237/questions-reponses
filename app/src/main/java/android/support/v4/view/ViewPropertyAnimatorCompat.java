...
/* loaded from: classes-dex2jar.jar:android/support/v4/view/ViewPropertyAnimatorCompat.class */
public final class ViewPropertyAnimatorCompat {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/view/ViewPropertyAnimatorCompat$ViewPropertyAnimatorListenerApi14.class */
    ...
    private void setListenerInternal(View view, ViewPropertyAnimatorListener viewPropertyAnimatorListener) {
        if (viewPropertyAnimatorListener != null) {
            view.animate().setListener(new AnimatorListenerAdapter(this, viewPropertyAnimatorListener, view) { // from class: android.support.v4.view.ViewPropertyAnimatorCompat.1
    ...
    public ViewPropertyAnimatorCompat setUpdateListener(ViewPropertyAnimatorUpdateListener viewPropertyAnimatorUpdateListener) {
        ...
        if (view != null && Build.VERSION.SDK_INT >= 19) {
            ...
            if (viewPropertyAnimatorUpdateListener != null) {
                animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener(this, viewPropertyAnimatorUpdateListener, view) { // from class: android.support.v4.view.ViewPropertyAnimatorCompat.2
                    final ViewPropertyAnimatorCompat this$0;
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat m7x(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat m8y(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat m9z(float f) {
        View view = this.mView.get();
        if (view != null && Build.VERSION.SDK_INT >= 21) {
            view.animate().z(f);
        }
