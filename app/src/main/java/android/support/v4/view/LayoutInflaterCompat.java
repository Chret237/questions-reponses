...
/* loaded from: classes-dex2jar.jar:android/support/v4/view/LayoutInflaterCompat.class */
public final class LayoutInflaterCompat {
    private static final String TAG = "LayoutInflaterCompatHC";
    private static boolean sCheckedField;
    private static Field sLayoutInflaterFactory2Field;

    /* loaded from: classes-dex2jar.jar:android/support/v4/view/LayoutInflaterCompat$Factory2Wrapper.class */
    ...
    public static void setFactory(LayoutInflater layoutInflater, LayoutInflaterFactory layoutInflaterFactory) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        ...
        if (factory instanceof LayoutInflater.Factory2) {
            ...
            forceSetFactory2(layoutInflater, factory2Wrapper2);
        }
    }
