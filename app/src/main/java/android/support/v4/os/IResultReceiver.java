...
/* loaded from: classes-dex2jar.jar:android/support/v4/os/IResultReceiver.class */
public interface IResultReceiver extends IInterface {

    /* loaded from: classes-dex2jar.jar:android/support/v4/os/IResultReceiver$Stub.class */
    public static abstract class Stub extends Binder implements IResultReceiver {
        private static final String DESCRIPTOR = "android.support.v4.os.IResultReceiver";
        static final int TRANSACTION_send = 1;

        /* loaded from: classes-dex2jar.jar:android/support/v4/os/IResultReceiver$Stub$Proxy.class */
