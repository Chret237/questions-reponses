...
/* loaded from: classes-dex2jar.jar:android/support/v4/graphics/ColorUtils.class */
public final class ColorUtils {
    ...
    public static double calculateContrast(int i, int i2) {
        ...
        int iCompositeColors = i;
        if (Color.alpha(i) < 255) {
            iCompositeColors = compositeColors(i, i2);
        }
        double dCalculateLuminance = calculateLuminance(iCompositeColors) + 0.05d;
    ...
    public static Color compositeColors(Color color, Color color2) {
        ...
        if (components2[componentCount] > 0.0f) {
            f2 = fAlpha / components2[componentCount];
            f = fAlpha2 / components2[componentCount];
        }
        for (int i = 0; i < componentCount; i++) {
            components2[i] = (components[i] * f2) + (components2[i] * f);
        }
