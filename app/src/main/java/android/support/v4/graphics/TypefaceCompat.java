...
/* loaded from: classes-dex2jar.jar:android/support/v4/graphics/TypefaceCompat.class */
public class TypefaceCompat {
    ...
    public static Typeface createFromResourcesFamilyXml(Context context, FontResourcesParserCompat.FamilyResourceEntry familyResourceEntry, Resources resources, int i, int i2, ResourcesCompat.FontCallback fontCallback, Handler handler, boolean z) {
        ...
        if (familyResourceEntry instanceof FontResourcesParserCompat.ProviderResourceEntry) {
            ...
            Typeface typefaceCreateFromFontFamilyFilesResourceEntry = sTypefaceCompatImpl.createFromFontFamilyFilesResourceEntry(context, (FontResourcesParserCompat.FontFamilyFilesResourceEntry) familyResourceEntry, resources, i2);
            fontSync = typefaceCreateFromFontFamilyFilesResourceEntry;
