...
/* loaded from: classes-dex2jar.jar:android/support/v4/widget/DirectedAcyclicGraph.class */
public final class DirectedAcyclicGraph<T> {
    ...
    private ArrayList<T> getEmptyList() {
        ...
        ArrayList<T> arrayList = arrayListAcquire;
    ...
    public void addEdge(T t, T t2) {
        ...
        ArrayList<T> emptyList = arrayList;
        if (arrayList == null) {
    ...
    public List<T> getOutgoingEdges(T t) {
        ...
        while (i < size) {
            ...
            if (arrayListValueAt != null) {
                ...
                if (arrayListValueAt.contains(t)) {
                    arrayList2 = arrayList;
                    if (arrayList == null) {
