...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent2, NestedScrollingChild2, ScrollingView {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/widget/NestedScrollView$AccessibilityDelegate.class */
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
            ...
            if (i == 4096) {
                ...
                int iMin = Math.min(nestedScrollView.getScrollY() + ((height - paddingBottom) - nestedScrollView.getPaddingTop()), nestedScrollView.getScrollRange());
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/widget/NestedScrollView$OnScrollChangeListener.class */
    ...
    */
    private android.view.View findFocusableViewInBounds(boolean r4, int r5, int r6) {
        /*
    ...
    private boolean scrollAndFocus(int i, int i2, int i3) {
        ...
        View view = viewFindFocusableViewInBounds;
        ...
        if (viewFindNextFocus == null || !isWithinDeltaOfScreen(viewFindNextFocus, maxScrollAmount, getHeight())) {
            if (i != 33 || getScrollY() >= maxScrollAmount) {
                ...
                if (i == 130) {
                    ...
                    if (getChildCount() > 0) {
                        View childAt = getChildAt(0);
                        iMin = Math.min((childAt.getBottom() + ((FrameLayout.LayoutParams) childAt.getLayoutParams()).bottomMargin) - ((getScrollY() + getHeight()) - getPaddingBottom()), maxScrollAmount);
                    }
                }
            } else {
                iMin = getScrollY();
    ...
    protected int computeScrollDeltaToGetChildRectOnScreen(Rect rect) {
        ...
        if (rect.bottom <= i3 || rect.top <= i2) {
            ...
            iMax = Math.min((rect.height() > height ? rect.top - i2 : rect.bottom - i3) + 0, (childAt.getBottom() + layoutParams.bottomMargin) - i);
        }
        return iMax;
    }
    ...
    */
    public void draw(android.graphics.Canvas r6) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.widget.NestedScrollView.draw(android.graphics.Canvas):void");
    }
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = 130;
        if (canScroll()) {
            boolean zArrowScroll = false;
            if (keyEvent.getAction() == 0) {
                int keyCode = keyEvent.getKeyCode();
                if (keyCode == 19) {
                    zArrowScroll = !keyEvent.isAltPressed() ? arrowScroll(33) : fullScroll(33);
                } else if (keyCode == 20) {
                    zArrowScroll = !keyEvent.isAltPressed() ? arrowScroll(130) : fullScroll(130);
                } else if (keyCode != 62) {
                    zArrowScroll = false;
                } else {
        ...
        if (isFocused()) {
            ...
            if (keyEvent.getKeyCode() != 4) {
                ...
                View viewFindNextFocus = FocusFinder.getInstance().findNextFocus(this, view, 130);
                z = false;
                if (viewFindNextFocus != null) {
                    z = false;
                    if (viewFindNextFocus != this) {
                        z = false;
                        if (viewFindNextFocus.requestFocus(130)) {
                            z = true;
                        }
                    }
                }
                ...
                if (iFindPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (dispatchNestedScroll(0, scrollY2, 0, i3 - scrollY2, this.mScrollOffset, 0)) {
                            ...
                            motionEventObtain.offsetLocation(0.0f, r0[1]);
                            this.mNestedYOffset += this.mScrollOffset[1];
                        } else if (z) {
                            ensureGlows();
                            int i4 = scrollY + i3;
                            if (i4 < 0) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowTop, i3 / getHeight(), motionEvent.getX(iFindPointerIndex) / getWidth());
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    this.mEdgeGlowBottom.onRelease();
                                }
                            } else if (i4 > scrollRange) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowBottom, i3 / getHeight(), 1.0f - (motionEvent.getX(iFindPointerIndex) / getWidth()));
    ...
    */
    ...
    public void scrollTo(int i, int i2) {
        if (getChildCount() > 0) {
            ...
            int iClamp2 = clamp(i2, (height - paddingTop) - paddingBottom, height2 + i5 + i6);
