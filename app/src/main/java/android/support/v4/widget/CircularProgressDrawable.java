...
/* loaded from: classes-dex2jar.jar:android/support/v4/widget/CircularProgressDrawable.class */
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/widget/CircularProgressDrawable$ProgressDrawableSize.class */
    public @interface ProgressDrawableSize {
    }

    /* loaded from: classes-dex2jar.jar:android/support/v4/widget/CircularProgressDrawable$Ring.class */
    ...
    private int evaluateColorChange(float f, int i, int i2) {
        return ((((i >> 24) & 255) + ((int) ((((i2 >> 24) & 255) - r0) * f))) << 24) | ((((i >> 16) & 255) + ((int) ((((i2 >> 16) & 255) - r0) * f))) << 16) | ((((i >> 8) & 255) + ((int) ((((i2 >> 8) & 255) - r0) * f))) << 8) | ((i & 255) + ((int) (f * ((i2 & 255) - r0))));
    }
    ...
    private void setupAnimators() {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this, ring) { // from class: android.support.v4.widget.CircularProgressDrawable.1
        ...
        valueAnimatorOfFloat.addListener(new Animator.AnimatorListener(this, ring) { // from class: android.support.v4.widget.CircularProgressDrawable.2
            final CircularProgressDrawable this$0;
            final Ring val$ring;
