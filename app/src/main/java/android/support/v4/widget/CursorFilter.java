...
/* loaded from: classes-dex2jar.jar:android/support/v4/widget/CursorFilter.class */
class CursorFilter extends Filter {
    CursorFilterClient mClient;

    /* loaded from: classes-dex2jar.jar:android/support/v4/widget/CursorFilter$CursorFilterClient.class */
