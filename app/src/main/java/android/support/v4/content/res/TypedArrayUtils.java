...
/* loaded from: classes-dex2jar.jar:android/support/v4/content/res/TypedArrayUtils.class */
public class TypedArrayUtils {
    ...
    public static String getString(TypedArray typedArray, int i, int i2) {
        ...
        if (string == null) {
            string2 = typedArray.getString(i2);
        }
        return string2;
    }
    ...
    public static CharSequence[] getTextArray(TypedArray typedArray, int i, int i2) {
        ...
        CharSequence[] textArray2 = textArray;
        if (textArray == null) {
            textArray2 = typedArray.getTextArray(i2);
        }
        return textArray2;
    }
