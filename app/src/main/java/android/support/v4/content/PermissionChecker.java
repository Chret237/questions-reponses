...
/* loaded from: classes-dex2jar.jar:android/support/v4/content/PermissionChecker.class */
public final class PermissionChecker {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/v4/content/PermissionChecker$PermissionResult.class */
    ...
    public static int checkPermission(Context context, String str, int i, int i2, String str2) {
        ...
        return AppOpsManagerCompat.noteProxyOpNoThrow(context, strPermissionToOp, str3) != 0 ? -2 : 0;
    }
