...
/* loaded from: classes-dex2jar.jar:android/support/v4/content/ContextCompat.class */
public class ContextCompat {
    private static final String TAG = "ContextCompat";
    private static final Object sLock = new Object();
    private static TypedValue sTempValue;

    /* loaded from: classes-dex2jar.jar:android/support/v4/content/ContextCompat$LegacyServiceMapHolder.class */
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            SERVICES.put(AudioManager.class, Format.AUDIO);
    ...
    public static <T> T getSystemService(Context context, Class<T> cls) {
        ...
        return (T) (systemServiceName != null ? context.getSystemService(systemServiceName) : null);
    }
