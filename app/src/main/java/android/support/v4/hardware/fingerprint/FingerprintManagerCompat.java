...
public final class FingerprintManagerCompat {
    ...
    private static FingerprintManager.AuthenticationCallback wrapCallback(AuthenticationCallback authenticationCallback) {
        return new FingerprintManager.AuthenticationCallback(authenticationCallback) { // from class: android.support.v4.hardware.fingerprint.FingerprintManagerCompat.1
