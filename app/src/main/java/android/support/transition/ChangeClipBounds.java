...
/* loaded from: classes-dex2jar.jar:android/support/transition/ChangeClipBounds.class */
            ...
            if (transitionValues2 != null) {
                ...
                if (transitionValues.values.containsKey(PROPNAME_CLIP)) {
                    if (transitionValues2.values.containsKey(PROPNAME_CLIP)) {
                        ...
                        if (z) {
                            objectAnimatorOfObject.addListener(new AnimatorListenerAdapter(this, transitionValues2.view) { // from class: android.support.transition.ChangeClipBounds.1
