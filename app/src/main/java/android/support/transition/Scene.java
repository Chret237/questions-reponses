...
public class Scene {
    ...
    static Scene getCurrentScene(View view) {
        return (Scene) view.getTag(C0149R.id.transition_current_scene);
    }

    public static Scene getSceneForLayout(ViewGroup viewGroup, int i, Context context) {
        SparseArray sparseArray = (SparseArray) viewGroup.getTag(C0149R.id.transition_scene_layoutid_cache);
        SparseArray sparseArray2 = sparseArray;
        if (sparseArray == null) {
            sparseArray2 = new SparseArray();
            viewGroup.setTag(C0149R.id.transition_scene_layoutid_cache, sparseArray2);
        }
    ...
    static void setCurrentScene(View view, Scene scene) {
        view.setTag(C0149R.id.transition_current_scene, scene);
    }
