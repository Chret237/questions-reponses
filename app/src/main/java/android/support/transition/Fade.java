...
/* loaded from: classes-dex2jar.jar:android/support/transition/Fade.class */
public class Fade extends Visibility {
    ...
    /* loaded from: classes-dex2jar.jar:android/support/transition/Fade$FadeAnimatorListener.class */
    ...
    private Animator createAnimation(View view, float f, float f2) {
        ...
        addListener(new TransitionListenerAdapter(this, view) { // from class: android.support.transition.Fade.1
            final Fade this$0;
            final View val$view;
