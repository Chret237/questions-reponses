...
/* loaded from: classes-dex2jar.jar:android/support/transition/ChangeScroll.class */
public class ChangeScroll extends Transition {
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        Animator animatorMergeAnimators = null;
        if (transitionValues != null) {
            if (transitionValues2 == null) {
                animatorMergeAnimators = null;
            } else {
                ...
                animatorMergeAnimators = TransitionUtils.mergeAnimators(objectAnimatorOfInt, objectAnimatorOfInt2);
            }
        }
