...
/* loaded from: classes-dex2jar.jar:android/arch/lifecycle/ClassesInfoCache.class */
class ClassesInfoCache {
    ...
    /* loaded from: classes-dex2jar.jar:android/arch/lifecycle/ClassesInfoCache$CallbackInfo.class */
    static class CallbackInfo {
        ...
        CallbackInfo(Map<MethodReference, Lifecycle.Event> map) {
            ...
            for (Map.Entry<MethodReference, Lifecycle.Event> entry : map.entrySet()) {
                ...
                List<MethodReference> arrayList = list;
                if (list == null) {
    ...
    /* loaded from: classes-dex2jar.jar:android/arch/lifecycle/ClassesInfoCache$MethodReference.class */
