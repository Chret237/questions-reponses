...
/* loaded from: classes-dex2jar.jar:com/squareup/picasso/UrlConnectionDownloader.class */
public class UrlConnectionDownloader implements Downloader {
    ...
    /* loaded from: classes-dex2jar.jar:com/squareup/picasso/UrlConnectionDownloader$ResponseCacheIcs.class */
    private static class ResponseCacheIcs {
        ...
        static Object install(Context context) throws IOException {
            ...
            HttpResponseCache httpResponseCacheInstall = installed;
            if (installed == null) {
                httpResponseCacheInstall = HttpResponseCache.install(fileCreateDefaultCacheDir, Utils.calculateDiskCacheSize(fileCreateDefaultCacheDir));
            }
            return httpResponseCacheInstall;
        }
    }
