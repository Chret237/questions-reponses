...
/* loaded from: classes-dex2jar.jar:com/squareup/picasso/Stats.class */
class Stats {
    ...
    /* loaded from: classes-dex2jar.jar:com/squareup/picasso/Stats$StatsHandler.class */
    private static class StatsHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 3) {
                ...
                Picasso.HANDLER.post(new Runnable(this, message) { // from class: com.squareup.picasso.Stats.StatsHandler.1
