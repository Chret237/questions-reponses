...
/* loaded from: classes-dex2jar.jar:com/squareup/picasso/PicassoExecutorService.class */
class PicassoExecutorService extends ThreadPoolExecutor {
    private static final int DEFAULT_THREAD_COUNT = 3;

    /* loaded from: classes-dex2jar.jar:com/squareup/picasso/PicassoExecutorService$PicassoFutureTask.class */
