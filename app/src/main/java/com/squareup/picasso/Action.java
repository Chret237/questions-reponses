...
/* loaded from: classes-dex2jar.jar:com/squareup/picasso/Action.class */
abstract class Action<T> {
    ...
    /* loaded from: classes-dex2jar.jar:com/squareup/picasso/Action$RequestWeakReference.class */
