...
/* loaded from: classes-dex2jar.jar:com/squareup/picasso/RequestCreator.class */
public class RequestCreator {
    ...
    private Request createRequest(long j) {
        ...
        requestBuild.f82id = andIncrement;
        ...
        if (requestTransformRequest != requestBuild) {
            requestTransformRequest.f82id = andIncrement;
    ...
    public void into(Target target) {
        ...
        if (!this.data.hasImage()) {
            ...
            Drawable placeholderDrawable2 = null;
            if (this.setPlaceholder) {
                placeholderDrawable2 = getPlaceholderDrawable();
            }
