...
/* loaded from: classes-dex2jar.jar:com/alibaba/fastjson/asm/MethodWriter.class */
public class MethodWriter implements MethodVisitor {
    private int access;
    private ByteVector code = new ByteVector();

    /* renamed from: cw */
    final ClassWriter f67cw;
    ...
    final void put(ByteVector byteVector) {
        ...
        if (this.code.length > 0) {
            byteVector.putShort(this.f67cw.newUTF8("Code")).putInt(this.code.length + 12 + 0);
        ...
        if (this.exceptionCount > 0) {
            byteVector.putShort(this.f67cw.newUTF8("Exceptions")).putInt((this.exceptionCount * 2) + 2);
    ...
    public void visitFieldInsn(int i, String str, String str2, String str3) {
        this.code.put12(i, this.f67cw.newFieldItem(str, str2, str3).index);
    }
    ...
    public void visitLdcInsn(Object obj) {
        Item itemNewConstItem = this.f67cw.newConstItem(obj);
    ...
    public void visitMethodInsn(int i, String str, String str2, String str3) {
        boolean z = i == 185;
        Item itemNewMethodItem = this.f67cw.newMethodItem(str, str2, str3, z);
        int i2 = itemNewMethodItem.intVal;
        if (!z) {
            this.code.put12(i, itemNewMethodItem.index);
            return;
        }
        int argumentsAndReturnSizes = i2;
        if (i2 == 0) {
    ...
    public void visitTypeInsn(int i, String str) {
        this.code.put12(i, this.f67cw.newClassItem(str).index);
    }
