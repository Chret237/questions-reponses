...
/* loaded from: classes-dex2jar.jar:com/alibaba/fastjson/util/ASMUtils.class */
public class ASMUtils {
    ...
    public static String[] lookupParameterNames(AccessibleObject accessibleObject) throws IOException {
        ...
        InputStream resourceAsStream = systemClassLoader.getResourceAsStream(declaringClass.getName().replace('.', '/') + ".class");
