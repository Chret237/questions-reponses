...
/* loaded from: classes-dex2jar.jar:com/alibaba/fastjson/serializer/GuavaCodec.class */
public class GuavaCodec implements ObjectSerializer, ObjectDeserializer {
    public static GuavaCodec instance = new GuavaCodec();

    /* JADX WARN: Type inference failed for: r0v5, types: [T, com.google.common.collect.ArrayListMultimap] */
