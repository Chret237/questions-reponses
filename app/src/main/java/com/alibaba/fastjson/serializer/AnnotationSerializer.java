...
/* loaded from: classes-dex2jar.jar:com/alibaba/fastjson/serializer/AnnotationSerializer.class */
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        ...
        if (interfaces.length == 1 && interfaces[0].isAnnotation()) {
            ...
            try {
                ...
                try {
                    Map map = (Map) sun_AnnotationType_members.invoke(sun_AnnotationType_getInstance.invoke(null, cls), new Object[0]);
