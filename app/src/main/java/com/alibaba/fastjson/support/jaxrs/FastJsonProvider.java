...
@Provider
@Consumes({"*/*"})
/* loaded from: classes-dex2jar.jar:com/alibaba/fastjson/support/jaxrs/FastJsonProvider.class */
public class FastJsonProvider implements MessageBodyReader<Object>, MessageBodyWriter<Object> {
                ...
                if (!subtype.endsWith("+json")) {
                    ...
                    if (!"javascript".equals(subtype)) {
                        ...
                        if (!"x-javascript".equals(subtype)) {
                            z = true;
                            if (!"x-json".equals(subtype)) {
                                z = true;
                                if (!"x-www-form-urlencoded".equalsIgnoreCase(subtype)) {
                                    z = subtype.endsWith("x-www-form-urlencoded");
                                }
                            }
                        }
                    }
    ...
    protected FastJsonConfig locateConfigProvider(Class<?> cls, MediaType mediaType) {
        ...
        if (providers != null) {
            ...
            ContextResolver contextResolver2 = contextResolver;
            if (contextResolver == null) {
                contextResolver2 = this.providers.getContextResolver(FastJsonConfig.class, (MediaType) null);
            }
            if (contextResolver2 != null) {
                return (FastJsonConfig) contextResolver2.getContext(cls);
            }
        }
        return this.fastJsonConfig;
    }
