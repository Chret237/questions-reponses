...
/* loaded from: classes-dex2jar.jar:com/alibaba/fastjson/support/spring/JSONPResponseBodyAdvice.class */
public class JSONPResponseBodyAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object obj, MethodParameter methodParameter, MediaType mediaType, Class<? extends HttpMessageConverter<?>> cls, ServerHttpRequest serverHttpRequest, ServerHttpResponse serverHttpResponse) {
        ...
        ResponseJSONP responseJSONP2 = responseJSONP;
        if (responseJSONP == null) {
            responseJSONP2 = (ResponseJSONP) methodParameter.getContainingClass().getAnnotation(ResponseJSONP.class);
        }
        String parameter = ((ServletServerHttpRequest) serverHttpRequest).getServletRequest().getParameter(responseJSONP2.callback());
        ...
        JSONPObject jSONPObject = new JSONPObject(str);
