...
/* loaded from: classes-dex2jar.jar:com/alibaba/fastjson/parser/deserializer/ASMDeserializerFactory.class */
public class ASMDeserializerFactory implements Opcodes {
    ...
    /* loaded from: classes-dex2jar.jar:com/alibaba/fastjson/parser/deserializer/ASMDeserializerFactory$Context.class */
    ...
    private void _deserialze(ClassWriter classWriter, Context context) {
        ...
        methodWriter.visitVarInsn(25, 1);
        methodWriter.visitMethodInsn(Opcodes.INVOKEVIRTUAL, DefaultJSONParser, "getContext", "()" + ASMUtils.desc((Class<?>) ParseContext.class));
        ...
        methodWriter.visitVarInsn(25, 3);
        methodWriter.visitMethodInsn(Opcodes.INVOKEVIRTUAL, DefaultJSONParser, "setContext", "(" + ASMUtils.desc((Class<?>) ParseContext.class) + "Ljava/lang/Object;Ljava/lang/Object;)" + ASMUtils.desc((Class<?>) ParseContext.class));
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (cls2 == Boolean.TYPE || cls2 == Byte.TYPE || cls2 == Short.TYPE || cls2 == Integer.TYPE) {
                ...
                if (cls2 == String.class) {
                    ...
                    methodWriter.visitJumpInsn(Opcodes.GOTO, label6);
            ...
            if (cls3 == Boolean.TYPE) {
                ...
                if (Collection.class.isAssignableFrom(cls3)) {
                    ...
                    if (collectionItemClass == String.class) {
                        ...
                        int i4 = i3;
                        _deserialze_list_obj(context, methodWriter, label, fieldInfo3, cls3, collectionItemClass, i4);
                        if (i4 == length - 1) {
                    ...
                    int i5 = i3;
                    _deserialze_obj(context, methodWriter, label, fieldInfo3, cls3, i5);
                    if (i5 == length - 1) {
                        _deserialize_endCheck(context, methodWriter, label);
                    }
                }
        ...
        if (i7 == 1) {
            ...
            methodWriter.visitIntInsn(16, i7);
        }
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            ...
            methodWriter.visitVarInsn(21, context.var("_asm_flag_" + i8));
    ...
    private void _deserialzeArrayMapping(ClassWriter classWriter, Context context) {
        ...
        methodWriter.visitVarInsn(25, 1);
        methodWriter.visitMethodInsn(Opcodes.INVOKEVIRTUAL, DefaultJSONParser, "getConfig", "()" + ASMUtils.desc((Class<?>) ParserConfig.class));
        methodWriter.visitVarInsn(25, 0);
    ...
    public ObjectDeserializer createJavaBeanDeserializer(ParserConfig parserConfig, JavaBeanInfo javaBeanInfo) throws Exception {
        ...
        Package r0 = ASMDeserializerFactory.class.getPackage();
        if (r0 != null) {
            String name = r0.getName();
            str2 = name.replace('.', '/') + "/" + str2;
            str = name + "." + str2;
        } else {
            str = str2;
        }
