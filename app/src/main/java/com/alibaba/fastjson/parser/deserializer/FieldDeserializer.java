...
/* loaded from: classes-dex2jar.jar:com/alibaba/fastjson/parser/deserializer/FieldDeserializer.class */
public abstract class FieldDeserializer {
    ...
    public void setValue(Object obj, Object obj2) {
        ...
        Object objTrim = obj2;
        if (this.fieldInfo.fieldClass == String.class) {
            objTrim = obj2;
            if (this.fieldInfo.format != null) {
                objTrim = obj2;
                if (this.fieldInfo.format.equals("trim")) {
                    objTrim = ((String) obj2).trim();
                }
            }
        }
        try {
            ...
            if (method != null) {
                ...
                if (this.fieldInfo.fieldClass == AtomicInteger.class) {
                    ...
                    if (atomicInteger != null) {
                        atomicInteger.set(((AtomicInteger) objTrim).get());
                        return;
                    }
                    return;
                }
                if (this.fieldInfo.fieldClass == AtomicLong.class) {
                    ...
                    if (atomicLong != null) {
                        atomicLong.set(((AtomicLong) objTrim).get());
                        return;
                    }
                    return;
                }
                if (this.fieldInfo.fieldClass == AtomicBoolean.class) {
                    ...
                    if (atomicBoolean != null) {
                        atomicBoolean.set(((AtomicBoolean) objTrim).get());
                        return;
                    }
                    return;
                }
                if (Map.class.isAssignableFrom(method.getReturnType())) {
                    ...
                    if (map != null && map != Collections.emptyMap() && !map.getClass().getName().startsWith("java.util.Collections$Unmodifiable")) {
                        map.putAll((Map) objTrim);
                        return;
                    }
                    return;
                }
                Collection collection = (Collection) method.invoke(obj, new Object[0]);
                if (collection != null && objTrim != null && collection != Collections.emptySet() && collection != Collections.emptyList() && !collection.getClass().getName().startsWith("java.util.Collections$Unmodifiable")) {
                    collection.clear();
                    collection.addAll((Collection) objTrim);
                    return;
                }
                return;
            }
            ...
            if (this.fieldInfo.fieldClass == AtomicInteger.class) {
                ...
                if (atomicInteger2 != null) {
                    atomicInteger2.set(((AtomicInteger) objTrim).get());
                    return;
                }
                return;
            }
            if (this.fieldInfo.fieldClass == AtomicLong.class) {
                ...
                if (atomicLong2 != null) {
                    atomicLong2.set(((AtomicLong) objTrim).get());
                    return;
                }
                return;
            }
            if (this.fieldInfo.fieldClass == AtomicBoolean.class) {
                ...
                if (atomicBoolean2 != null) {
                    atomicBoolean2.set(((AtomicBoolean) objTrim).get());
                    return;
                }
                return;
            }
            if (Map.class.isAssignableFrom(this.fieldInfo.fieldClass)) {
                ...
                if (map2 != null && map2 != Collections.emptyMap() && !map2.getClass().getName().startsWith("java.util.Collections$Unmodifiable")) {
                    map2.putAll((Map) objTrim);
                    return;
                }
                return;
            }
            Collection collection2 = (Collection) field.get(obj);
            if (collection2 != null && objTrim != null && collection2 != Collections.emptySet() && collection2 != Collections.emptyList() && !collection2.getClass().getName().startsWith("java.util.Collections$Unmodifiable")) {
                collection2.clear();
                collection2.addAll((Collection) objTrim);
            }
        } catch (Exception e) {
