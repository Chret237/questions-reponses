...
/* loaded from: classes-dex2jar.jar:com/alibaba/fastjson/parser/deserializer/ResolveFieldDeserializer.class */
public final class ResolveFieldDeserializer extends FieldDeserializer {
    ...
    @Override // com.alibaba.fastjson.parser.deserializer.FieldDeserializer
    public void setValue(Object obj, Object obj2) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
        JSONArray jSONArray;
        Object relatedArray;
        Map map = this.map;
        if (map != null) {
        ...
        if (jSONArray.getComponentType() != null) {
            objCast = TypeUtils.cast(obj2, jSONArray.getComponentType(), this.parser.getConfig());
        }
        Array.set(relatedArray, this.index, objCast);
    }
}
