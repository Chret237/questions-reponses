...
/* loaded from: classes-dex2jar.jar:com/github/kiulian/downloader/model/videos/formats/Itag.class */
public enum Itag {
    unknown { // from class: com.github.kiulian.downloader.model.videos.formats.Itag.1
        @Override // com.github.kiulian.downloader.model.videos.formats.Itag
    ...
    Itag(VideoQuality videoQuality, AudioQuality audioQuality, boolean z) {
    ...
    public boolean isAudio() {
        return (this == unknown || this.audioQuality == AudioQuality.noAudio) ? false : true;
    }

    public boolean isVideo() {
        return (this == unknown || this.videoQuality == VideoQuality.noVideo) ? false : true;
    }
    ...
    public String toString() {
        return String.valueOf(this.f79id);
    }
