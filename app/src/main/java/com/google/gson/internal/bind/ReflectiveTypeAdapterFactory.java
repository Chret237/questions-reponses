...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private BoundField createBoundField(Gson gson, Field field, String str, TypeToken<?> typeToken, boolean z, boolean z2) {
        ...
        return new BoundField(this, str, z, z2, field, z3, adapter, gson, typeToken, zIsPrimitive) { // from class: com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.1
        ...
        while (cls != Object.class) {
            for (Field field : cls.getDeclaredFields()) {
                ...
                if (zExcludeField || zExcludeField2) {
                    ...
                    Type typeResolve = C$Gson$Types.resolve(typeToken2.getType(), cls, field.getGenericType());
