...
public class TypeToken<T> {
    ...
    private static boolean isAssignableFrom(Type type, GenericArrayType genericArrayType) {
        ...
        Type genericComponentType2 = genericArrayType.getGenericComponentType();
        ...
        return isAssignableFrom(genericComponentType, (ParameterizedType) genericComponentType2, new HashMap());
    }
